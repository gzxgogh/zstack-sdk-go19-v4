...
// 查询全局设置
func QueryGlobalConfig(params model.QueryGlobalConfigRequest) models.Result[any] {
...
// 更新全局设置
func UpdateGlobalConfig(params model.UpdateGlobalConfigRequest) models.Result[any] {
...
// 重置全局配置
func ResetGlobalConfig(params model.ResetGlobalConfigRequest) models.Result[any] {
...
// 获取资源的资源高级设置
func GetResourceConfig(params model.GetResourceConfigRequest) models.Result[any] {
...
// 获取可配置的资源高级设置
func GetResourceBindableConfig(params model.GetResourceBindableConfigRequest) models.Result[any] {
...
// 删除资源的资源高级设置
func DeleteResourceConfig(params model.DeleteResourceConfigRequest) models.Result[any] {
...
// 查询资源高级设置
func QueryResourceConfig(params model.QueryResourceConfigRequest) models.Result[any] {
...
// 更新资源高级设置
func UpdateResourceConfig(params model.UpdateResourceConfigRequest) models.Result[any] {
...
// 应用模板
func ApplyTemplateConfig(params model.ApplyTemplateConfigRequest) models.Result[any] {
...
// 查询所有模板信息
func QueryGlobalConfigTemplate(params model.QueryGlobalConfigTemplateRequest) models.Result[any] {
...
// 查询模板具体配置
func QueryTemplateConfig(params model.QueryTemplateConfigRequest) models.Result[any] {
...
// 更新模板值
func UpdateTemplateConfig(params model.UpdateTemplateConfigRequest) models.Result[any] {
	//PUT zstack/v1/template-configurations/{templateUuid}/actions
	url := fmt.Sprintf("zstack/v1/template-configurations/%s/actions", params.TemplateUuid)
...
// 重置模板到初始状态
func ResetTemplateConfig(params model.ResetTemplateConfigRequest) models.Result[any] {
	//PUT zstack/v1/template-configurations/{templateUuid}/actions
	url := fmt.Sprintf("zstack/v1/template-configurations/%s/actions", params.TemplateUuid)
