...
// 创建策略路由规则集
func CreatePolicyRouteRuleSet(params model.CreatePolicyRouteRuleSetRequest) models.Result[any] {
...
// 删除策略路由规则集
func DeletePolicyRouteRuleSet(params model.DeletePolicyRouteRuleSetRequest) models.Result[any] {
...
// 更新策略路由规则集属性
func UpdatePolicyRouteRuleSet(params model.UpdatePolicyRouteRuleSetRequest) models.Result[any] {
...
// 查询策略路由规则集
func QueryPolicyRouteRuleSet(params model.QueryPolicyRouteRuleSetRequest) models.Result[any] {
...
// 查询策略路由规则集网络关联
func QueryPolicyRouteRuleSetL3Ref(params model.QueryPolicyRouteRuleSetL3RefRequest) models.Result[any] {
...
// 查询策略路由规则集与单节点云路由关联
func QueryPolicyRouteRuleSetVRouterRef(params model.QueryPolicyRouteRuleSetVRouterRefRequest) models.Result[any] {
...
// 创建策略路由规则集规则
func CreatePolicyRouteRule(params model.CreatePolicyRouteRuleRequest) models.Result[any] {
...
// 删除策略路由规则集规则
func DeletePolicyRouteRule(params model.DeletePolicyRouteRuleRequest) models.Result[any] {
...
// 创建策略路由表
func CreatePolicyRouteTable(params model.CreatePolicyRouteTableRequest) models.Result[any] {
...
// 删除策略路由表
func DeletePolicyRouteTable(params model.DeletePolicyRouteTableRequest) models.Result[any] {
...
// 查询策略路由表
func QueryPolicyRouteTable(params model.QueryPolicyRouteTableRequest) models.Result[any] {
...
// 查询策略路由表与单节点云路由关联
func QueryPolicyRouteTableVRouterRef(params model.QueryPolicyRouteTableVRouterRefeRequest) models.Result[any] {
...
// 创建策略路由
func CreatePolicyRouteTableRouteEntry(params model.CreatePolicyRouteTableRouteEntryRequest) models.Result[any] {
...
// 删除策略路由
func DeletePolicyRouteTableRouteEntry(params model.DeletePolicyRouteTableRouteEntryRequest) models.Result[any] {
...
// 查询策略路由
func QueryPolicyRouteTableRouteEntry(params model.QueryPolicyRouteTableRouteEntryRequest) models.Result[any] {
...
// 查询策略路由规则
func QueryPolicyRouteRule(params model.QueryPolicyRouteRuleRequest) models.Result[any] {
...
// 网络加载策略路由规则集
func AttachPolicyRouteRuleSetToL3(params model.AttachPolicyRouteRuleSetToL3Request) models.Result[any] {
...
// 网络解绑策略路由
func DetachPolicyRouteRuleSetFromL3(params model.DetachPolicyRouteRuleSetFromL3Request) models.Result[any] {
...
// 获取虚拟路由器的策略路由集合
func GetPolicyRouteRuleSetFromVirtualRouter(params model.GetPolicyRouteRuleSetFromVirtualRouterRequest) models.Result[any] {
