...
// 创建资源价格
func CreateResourcePrice(params model.CreateResourcePriceRequest) models.Result[any] {
...
// 删除资源价格
func DeleteResourcePrice(params model.DeleteResourcePriceRequest) models.Result[any] {
...
// 修改资源价格
func UpdateResourcePrice(params model.UpdateResourcePriceRequest) models.Result[any] {
...
// 查询资源价格
func QueryResourcePrice(params model.QueryResourcePriceRequest) models.Result[any] {
...
// 计算账户花费
func CalculateAccountSpending(params model.CalculateAccountSpendingRequest) models.Result[any] {
...
// 查询账户账单
func QueryAccountBilling(params model.QueryAccountBillingRequest) models.Result[any] {
...
// 创建计费价目
func CreatePriceTable(params model.CreatePriceTableRequest) models.Result[any] {
...
// 删除计费价目
func DeletePriceTable(params model.DeletePriceTableRequest) models.Result[any] {
...
// 修改计费价目
func UpdatePriceTable(params model.UpdatePriceTableRequest) models.Result[any] {
...
// 查询计费价目
func QueryPriceTable(params model.QueryPriceTableRequest) models.Result[any] {
...
// 为账户项目指定计费价目
func AttachPriceTableToAccount(params model.AttachPriceTableToAccountRequest) models.Result[any] {
...
// 取消账户项目关联的计费价目
func DetachPriceTableFromAccount(params model.DetachPriceTableFromAccountRequest) models.Result[any] {
...
// 修改账户项目计费价目
func ChangeAccountPriceTableBinding(params model.ChangeAccountPriceTableBindingRequest) models.Result[any] {
...
// 获得项目账户使用的计费价目
func GetAccountPriceTableRef(params model.GetAccountPriceTableRefRequest) models.Result[any] {
...
// 查询账户项目与计费价目的关联关系
func QueryAccountPriceTableRef(params model.QueryAccountPriceTableRefRequest) models.Result[any] {
...
// 生成账单
func GenerateAccountBilling(params model.GenerateAccountBillingRequest) models.Result[any] {
	//PUT zstack/v1/billings/accounts/{accountUuid}/actions
