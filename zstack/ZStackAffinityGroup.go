...
// 创建亲和组
func CreateAffinityGroup(params model.CreateAffinityGroupRequest) models.Result[any] {
...
// 删除亲和组
func DeleteAffinityGroup(params model.DeleteAffinityGroupRequest) models.Result[any] {
...
// 查询亲和组
func QueryAffinityGroup(params model.QueryAffinityGroupRequest) models.Result[any] {
...
// 更新亲和组
func UpdateAffinityGroup(params model.UpdateAffinityGroupRequest) models.Result[any] {
...
// 添加云主机到亲和组
func AddVmToAffinityGroup(params model.AddVmToAffinityGroupRequest) models.Result[any] {
...
// 从亲和组移除云主机
func RemoveVmFromAffinityGroup(params model.RemoveVmFromAffinityGroupRequest) models.Result[any] {
...
// 改变亲和组的使用状态
func ChangeAffinityGroupState(params model.ChangeAffinityGroupStateRequest) models.Result[any] {
	//PUT zstack/v1/affinity-groups/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/affinity-groups/%s/actions", params.UUID)
...
// 获取可绑定云主机的亲和组
func GetCandidateAffinityGroupForAttachingVm(params model.GetCandidateAffinityGroupForAttachingVmRequest) models.Result[any] {
...
// 获取可绑定亲和组的云主机
func GetCandidateVMForAttachingAffinityGroup(params model.GetCandidateVMForAttachingAffinityGroupRequest) models.Result[any] {
...
// 创建云主机时获取可加入非亲和组
func GetCandidateAffinityGroupForCreatingVm(params model.GetCandidateAffinityGroupForCreatingVmRequest) models.Result[any] {
