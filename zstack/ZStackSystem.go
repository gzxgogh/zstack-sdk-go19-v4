...
// 查询管理节点
func QueryManagementNode(params model.QueryManagementNodeRequest) models.Result[any] {
	...
	return models.Success[any](respResult)
}

// 获取当前版本
func GetVersion(params model.GetVersionRequest) models.Result[any] {
...
// 获取当前时间
func GetCurrentTime(params model.GetCurrentTimeRequest) models.Result[any] {
	//PUT zstack/v1/management-nodes/actions
	url := fmt.Sprintf("zstack/v1/management-nodes/actions")
...
// 获取管理节点当前的时区信息
func GetPlatformTimeZone(params model.GetPlatformTimeZoneRequest) models.Result[any] {
	//PUT zstack/v1/management-nodes/actions
	url := fmt.Sprintf("zstack/v1/management-nodes/actions")
...
// 检查管理节点是否能正常开始工作
func IsReadyToGo(params model.IsReadyToGoRequest) models.Result[any] {
...
// 获取管理节点操作系统信息
func GetManagementNodeOS(params model.GetManagementNodeOSRequest) models.Result[any] {
...
// 获取管理节点CPU架构类型
func GetManagementNodeArch(params model.GetManagementNodeArchRequest) models.Result[any] {
	//PUT zstack/v1/management/actions
	url := fmt.Sprintf("zstack/v1/management/actions")
...
// 创建系统标签
func CreateSystemTag(params model.CreateSystemTagRequest) models.Result[any] {
...
// 查询系统标签
func QuerySystemTag(params model.QuerySystemTagRequest) models.Result[any] {
...
// 更新系统标签
func UpdateSystemTag(params model.UpdateSystemTagRequest) models.Result[any] {
...
// 创建用户标签
func CreateUserTag(params model.CreateUserTagRequest) models.Result[any] {
...
// 查询用户标签
func QueryUserTag(params model.QueryUserTagRequest) models.Result[any] {
...
// 删除标签
func DeleteTag(params model.DeleteTagRequest) models.Result[any] {
...
// 创建资源标签
func CreateTag(params model.CreateTagRequest) models.Result[any] {
	//POST zstack/v1/tags
...
// 查询资源标签
func QueryTag(params model.QueryTagRequest) models.Result[any] {
	//GET zstack/v1/tags
...
// 更新资源标签
func UpdateTag(params model.UpdateTagRequest) models.Result[any] {
...
// 加载资源标签
func AttachTagToResources(params model.AttachTagToResourcesRequest) models.Result[any] {
...
// 卸载资源标签
func DetachTagFromResources(params model.DetachTagFromResourcesRequest) models.Result[any] {
...
// 获取任务进度
func GetTaskProgress(params model.GetTaskProgressRequest) models.Result[any] {
...
// 获取CPU和内存容量
func GetCpuMemoryCapacity(params model.GetCpuMemoryCapacityRequest) models.Result[any] {
...
// 触发垃圾回收任务
func TriggerGCJob(params model.TriggerGCJobRequest) models.Result[any] {
...
// 删除垃圾回收任务
func DeleteGCJob(params model.DeleteGCJobRequest) models.Result[any] {
...
// 查询垃圾回收任务
func QueryGCJob(params model.QueryGCJobRequest) models.Result[any] {
...
// 获取许可证信息
func GetLicenseInfo(params model.GetLicenseInfoRequest) models.Result[any] {
...
// 获取许可证历史授权信息
func GetLicenseRecords(params model.GetLicenseRecordsRequest) models.Result[any] {
	//GET zstack/v1/licenses
	url := fmt.Sprintf("zstack/v1/licenses")
...
// 获取许可证容量
func GetLicenseCapabilities(params model.GetLicenseCapabilitiesRequest) models.Result[any] {
...
// 删除许可证文件
func DeleteLicense(params model.DeleteLicenseRequest) models.Result[any] {
...
// 重新加载许可证
func ReloadLicense(params model.ReloadLicenseRequest) models.Result[any] {
...
// 更新许可证信息
func UpdateLicense(params model.UpdateLicenseRequest) models.Result[any] {
...
// 提交长时任务
func SubmitLongJob(params model.SubmitLongJobRequest) models.Result[any] {
...
// 更新长时任务
func UpdateLongJob(params model.UpdateLongJobRequest) models.Result[any] {
...
// 删除长时任务
func DeleteLongJob(params model.DeleteLongJobRequest) models.Result[any] {
...
// 查询长时任务
func QueryLongJob(params model.QueryLongJobRequest) models.Result[any] {
...
// 查看系统错误码
func GetElaborations(params model.GetElaborationsRequest) models.Result[any] {
...
// 重新生成索引
func RefreshSearchIndexes(params model.RefreshSearchIndexesRequest) models.Result[any] {
	//GET zstack/v1/errorcode/elaborations
	url := fmt.Sprintf("zstack/v1/errorcode/elaborations")
