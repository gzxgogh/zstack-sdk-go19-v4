...
// 添加AD/LDAP服务器
func AddLdapServer(params model.AddLdapServerRequest) models.Result[any] {
...
// 删除AD/LDAP服务器
func DeleteLdapServer(params model.DeleteLdapServerRequest) models.Result[any] {
...
// 查询AD/LDAP服务器
func QueryLdapServer(params model.QueryLdapServerRequest) models.Result[any] {
...
// 更新AD/LDAP服务器
func UpdateLdapServer(params model.UpdateLdapServerRequest) models.Result[any] {
...
// 创建AD/LDAP绑定
func CreateLdapBinding(params model.CreateLdapBindingRequest) models.Result[any] {
...
// 删除AD/LDAP绑定
func DeleteLdapBinding(params model.DeleteLdapBindingRequest) models.Result[any] {
...
// 查询AD/LDAP绑定
func QueryLdapBinding(params model.QueryLdapBindingRequest) models.Result[any] {
...
// 清理无效的AD/LDAP绑定
func CleanInvalidLdapBinding(params model.CleanInvalidLdapBindingRequest) models.Result[any] {
...
// 使用AD/LDAP身份登录
func LogInByLdap(params model.LogInByLdapRequest) models.Result[any] {
...
// 获取AD/LDAP条目
func GetLdapEntry(params model.GetLdapEntryRequest) models.Result[any] {
...
// 获取可绑定的AD/LDAP条目
func GetCandidateLdapEntryForBinding(params model.GetCandidateLdapEntryForBindingRequest) models.Result[any] {
