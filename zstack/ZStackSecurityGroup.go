...
// 创建安全组
func CreateSecurityGroup(params model.CreateSecurityGroupRequest) models.Result[any] {
...
// 删除安全组
func DeleteSecurityGroup(params model.DeleteSecurityGroupRequest) models.Result[any] {
...
// 查询安全组
func QuerySecurityGroup(params model.QuerySecurityGroupRequest) models.Result[any] {
...
// 更新安全组
func UpdateSecurityGroup(params model.UpdateSecurityGroupRequest) models.Result[any] {
...
// 改变安全组状态
func ChangeSecurityGroupState(params model.ChangeSecurityGroupStateRequest) models.Result[any] {
	//PUT zstack/v1/security-groups/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/security-groups/%s/actions", params.UUID)
...
// 挂载安全组到L3网络
func AttachSecurityGroupToL3Network(params model.AttachSecurityGroupToL3NetworkRequest) models.Result[any] {
...
// 从L3网络卸载安全组
func DetachSecurityGroupFromL3Network(params model.DetachSecurityGroupFromL3NetworkRequest) models.Result[any] {
...
// 获取网卡列表清单
func GetCandidateVmNicForSecurityGroup(params model.GetCandidateVmNicForSecurityGroupRequest) models.Result[any] {
...
// 添加虚拟机网卡到安全组
func AddVmNicToSecurityGroup(params model.AddVmNicToSecurityGroupRequest) models.Result[any] {
...
// 从安全组删除虚拟机网卡
func DeleteVmNicFromSecurityGroup(params model.DeleteVmNicFromSecurityGroupRequest) models.Result[any] {
...
// 查询应用了安全组的网卡列表
func QueryVmNicInSecurityGroup(params model.QueryVmNicInSecurityGroupRequest) models.Result[any] {
...
// 添加规则到安全组
func AddSecurityGroupRule(params model.AddSecurityGroupRuleRequest) models.Result[any] {
...
// 查询安全组规则
func QuerySecurityGroupRule(params model.QuerySecurityGroupRuleRequest) models.Result[any] {
...
// 删除安全组规则
func DeleteSecurityGroupRule(params model.DeleteSecurityGroupRuleRequest) models.Result[any] {
