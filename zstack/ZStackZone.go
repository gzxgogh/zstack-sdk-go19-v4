...
// 创建区域
func CreateZone(params model.CreateZoneRequest) models.Result[any] {
...
// 删除区域
func DeleteZone(params model.DeleteZoneRequest) models.Result[any] {
...
// 查询区域
func QueryZone(params model.QueryZoneRequest) models.Result[any] {
	//GET zstack/v1/zones
...
// 更新区域
func UpdateZone(params model.UpdateZoneRequest) models.Result[any] {
...
// 改变区域的可用状态
func ChangeZoneState(params model.ChangeZoneStateRequest) models.Result[any] {
	//PUT zstack/v1/zones/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/zones/%s/actions", params.UUID)
