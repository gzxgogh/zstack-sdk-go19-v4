...
// 创建路由区域资源
func CreateVRouterOspfArea(params model.CreateVRouterOspfArea) models.Result[any] {
...
// 删除OSPF路由区域
func DeleteVRouterOspfArea(params model.DeleteVRouterOspfAreaRequest) models.Result[any] {
...
// 获取OSPF的邻居信息
func GetVRouterOspfNeighbor(params model.GetVRouterOspfNeighborRequest) models.Result[any] {
...
// 查询OSPF路由区域信息
func QueryVRouterOspfArea(params model.QueryVRouterOspfAreaRequest) models.Result[any] {
...
// 获取路由器的ID
func GetVRouterRouterId(params model.GetVRouterRouterIdRequest) models.Result[any] {
...
// 设置路由器的ID
func SetVRouterRouterId(params model.SetVRouterRouterIdRequest) models.Result[any] {
...
// 添加网络到OSPF的区域
func AddVRouterNetworksToOspfArea(params model.AddVRouterNetworksToOspfAreaRequest) models.Result[any] {
...
// 从路由区域中移除网络
func RemoveVRouterNetworksFromOspfArea(params model.RemoveVRouterNetworksFromOspfAreaRequest) models.Result[any] {
...
// 更改OSPF的路由区域属性
func UpdateVRouterOspfArea(params model.UpdateVRouterOspfAreaRequest) models.Result[any] {
...
// 查询路由加入到区域的网络信息
func QueryVRouterOspfNetwork(params model.QueryVRouterOspfNetworkRequest) models.Result[any] {
