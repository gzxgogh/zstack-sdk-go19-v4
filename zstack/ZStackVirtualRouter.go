...
// 重连VPC路由器
func ReconnectVirtualRouter(params model.ReconnectVirtualRouterRequest) models.Result[any] {
...
// 查询云路由器
func QueryVirtualRouterVm(params model.QueryVirtualRouterVmRequest) models.Result[any] {
...
// 查询服务云主机
func QueryApplianceVm(params model.QueryApplianceVmRequest) models.Result[any] {
...
// 创建云路由规格
func CreateVirtualRouterOffering(params model.CreateVirtualRouterOfferingRequest) models.Result[any] {
...
// 查询云路由规格
func QueryVirtualRouterOffering(params model.QueryVirtualRouterOfferingRequest) models.Result[any] {
...
// 更新云路由规格
func UpdateVirtualRouterOffering(params model.UpdateVirtualRouterOfferingRequest) models.Result[any] {
...
// 获取云路由器可加载外部网络
func GetAttachablePublicL3ForVRouter(params model.GetAttachablePublicL3ForVRouterRequest) models.Result[any] {
...
// 创建云路由路由表
func CreateVRouterRouteTable(params model.CreateVRouterRouteTableRequest) models.Result[any] {
...
// 删除云路由路由表
func DeleteVRouterRouteTable(params model.DeleteVRouterRouteTableRequest) models.Result[any] {
...
// 查询云路由路由表
func QueryVRouterRouteTable(params model.QueryVRouterRouteTableRequest) models.Result[any] {
...
// 获取路由器实时路由表
func GetVRouterRouteTable(params model.GetVRouterRouteTableRequest) models.Result[any] {
...
// 添加云路由路由条目
func AddVRouterRouteEntry(params model.AddVRouterRouteEntryRequest) models.Result[any] {
...
// 删除云路由路由条目
func DeleteVRouterRouteEntry(params model.DeleteVRouterRouteEntryRequest) models.Result[any] {
...
// 查询云路由路由条目
func QueryVRouterRouteEntry(params model.QueryVRouterRouteEntryRequest) models.Result[any] {
...
// 绑定云路由路由表到云路由器
func AttachVRouterRouteTableToVRouter(params model.AttachVRouterRouteTableToVRouterRequest) models.Result[any] {
...
// 解绑云路由路由表
func DetachVRouterRouteTableFromVRouter(params model.DetachVRouterRouteTableFromVRouterRequest) models.Result[any] {
...
// 查询绑定关系
func QueryVirtualRouterVRouterRouteTableRef(params model.QueryVirtualRouterVRouterRouteTableRefRequest) models.Result[any] {
