...
// 创建云盘规格
func CreateDiskOffering(params model.CreateDiskOfferingRequest) models.Result[any] {
...
// 删除云盘规格
func DeleteDiskOffering(params model.DeleteDiskOfferingRequest) models.Result[any] {
...
// 查询云盘规格
func QueryDiskOffering(params model.QueryDiskOfferingRequest) models.Result[any] {
...
// 更改云盘规格的启用状态
func ChangeDiskOfferingState(params model.ChangeDiskOfferingStateRequest) models.Result[any] {
...
// 更新云盘规格
func UpdateDiskOffering(params model.UpdateDiskOfferingRequest) models.Result[any] {
	//PUT zstack/v1/disk-offerings/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/disk-offerings/%s/actions", params.UUID)
