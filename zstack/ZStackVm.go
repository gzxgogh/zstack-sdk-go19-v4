...
// 创建云主机
func CreateVmInstances(params model.CreateVmInstanceRequest) models.Result[any] {
	...
	return models.Success[any](vmInstanceResp)
}

// 从云盘创建云主机
func CreateVmInstanceFromVolume(params model.CreateVmFromVolumeRequest) models.Result[any] {
...
// 从快照创建云主机
func CreateVmInstanceFromVolumeSnapshot(params model.CreateVmInstanceFromVolumeSnapshotRequest) models.Result[any] {
...
// 从快照组创建云主机
func CreateVmInstanceFromVolumeSnapshotGroup(params model.CreateVmInstanceFromVolumeSnapshotGroupRequest) models.Result[any] {
...
// 删除云主机
func DestroyVmInstance(vmInstance model.DestroyVmInstanceRequest) models.Result[any] {
...
// 恢复已删除云主机
func RecoverVmInstance(vmInstance model.RecoverVmInstanceRequest) models.Result[any] {
...
// 彻底删除云主机
func ExpungeVmInstance(vmInstance model.ExpungeVmInstanceRequest) models.Result[any] {
	//PUT zstack/v1/vm-instances/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/vm-instances/%s/actions", vmInstance.UUID)
	dataStr, err := request.Put(url, vmInstance)
	if err != nil {
...
// 查询云主机
func QueryVmInstance(vmInstance model.QueryVmInstanceRequest) models.Result[any] {
...
// 根据ip查询云主机
func QueryVmByIp(params model.QueryVmByIpRequest) models.Result[any] {
...
// 启动云主机
func StartVmInstance(vmInstance model.StartVmInstanceRequest) models.Result[any] {
	//PUT zstack/v1/vm-instances/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/vm-instances/%s/actions", vmInstance.UUID)
	dataStr, err := request.Put(url, vmInstance)
	if err != nil {
...
// 停止云主机
func StopVmInstance(vmInstance model.StopVmInstanceRequest) models.Result[any] {
	//PUT zstack/v1/vm-instances/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/vm-instances/%s/actions", vmInstance.UUID)
	dataStr, err := request.Put(url, vmInstance)
	if err != nil {
...
// 重启云主机
func RebootVmInstance(vmInstance model.RebootVmInstanceRequest) models.Result[any] {
	//PUT zstack/v1/vm-instances/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/vm-instances/%s/actions", vmInstance.UUID)
	dataStr, err := request.Put(url, vmInstance)
	if err != nil {
...
// 暂停云主机
func PauseVmInstance(vmInstance model.PauseVmInstanceRequest) models.Result[any] {
	//PUT zstack/v1/vm-instances/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/vm-instances/%s/actions", vmInstance.UUID)
	dataStr, err := request.Put(url, vmInstance)
	if err != nil {
...
// 恢复暂停的云主机
func ResumeVmInstance(vmInstance model.ResumeVmInstanceRequest) models.Result[any] {
	//PUT zstack/v1/vm-instances/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/vm-instances/%s/actions", vmInstance.UUID)
	dataStr, err := request.Put(url, vmInstance)
	if err != nil {
...
func ReimageVmInstance(vmInstance model.ReimageVmInstanceRequest) models.Result[any] {
...
// 热迁移云主机
func MigrateVm(vmInstance model.MigrateVmRequest) models.Result[any] {
	//PUT zstack/v1/vm-instances/{vmInstanceUuid}/actions
	url := fmt.Sprintf("zstack/v1/vm-instances/%s/actions", vmInstance.VmInstanceUuid)
	dataStr, err := request.Put(url, vmInstance)
	if err != nil {
...
// 查询共享磁盘所挂载的云主机
func QueryShareableVolumeVmInstanceRef(vmInstance model.QueryShareableVolumeVmInstanceRefRequest) models.Result[any] {
...
// 获取可热迁移的物理机列表
func GetVmMigrationCandidateHosts(vmInstance model.GetVmMigrationCandidateHostsRequest) models.Result[any] {
...
// 获取可选择的主存储
func GetCandidatePrimaryStoragesForCreatingVm(vmInstance model.GetCandidatePrimaryStoragesForCreatingVmRequest) models.Result[any] {
...
// 获取云主机可加载ISO列表
func GetCandidateIsoForAttachingVm(vmInstance model.GetCandidateIsoForAttachingVmRequest) models.Result[any] {
...
// 获取ISO可加载云主机列表
func GetCandidateVmForAttachingIso(vmInstance model.GetCandidateVmForAttachingIsoRequest) models.Result[any] {
...
// 加载ISO到云主机
func AttachIsoToVmInstance(vmInstance model.AttachIsoToVmInstanceRequest) models.Result[any] {
...
// 卸载云主机上的ISO
func DetachIsoFromVmInstance(vmInstance model.DetachIsoFromVmInstanceRequest) models.Result[any] {
...
// 获取云主机可加载云盘列表
func GetVmAttachableDataVolume(vmInstance model.GetVmAttachableDataVolumeRequest) models.Result[any] {
...
// 获取云主机可加载L3网络列表
func GetVmAttachableL3Network(vmInstance model.GetVmAttachableL3NetworkRequest) models.Result[any] {
...
// 加载L3网络到云主机
func AttachL3NetworkToVm(vmInstance model.AttachL3NetworkToVmRequest) models.Result[any] {
...
// 从云主机卸载网络
func DetachL3NetworkFromVm(vmInstance model.DetachL3NetworkFromVmRequest) models.Result[any] {
...
// 创建云主机网卡
func CreateVmNic(vmInstance model.CreateVmNicRequest) models.Result[any] {
	//POST zstack/v1/nics
...
// 加载网卡到云主机
func AttachVmNicToVm(vmInstance model.AttachVmNicToVmRequest) models.Result[any] {
...
// 删除云主机网卡
func DeleteVmNic(vmInstance model.DeleteVmNicRequest) models.Result[any] {
...
// 查询云主机网卡
func QueryVmNic(vmInstance model.QueryVmNicRequest) models.Result[any] {
...
// 获取网卡加载的网络服务名称
func GetVmNicAttachedNetworkService(vmInstance model.GetVmNicAttachedNetworkServiceRequest) models.Result[any] {
...
// 修改云主机网卡三层网络
func ChangeVmNicNetwork(vmInstance model.ChangeVmNicNetworkRequest) models.Result[any] {
...
// 获取云主机网卡可挂载的三层网络
func GetCandidateL3NetworksForChangeVmNicNetwork(vmInstance model.GetCandidateL3NetworksForChangeVmNicNetworkRequest) models.Result[any] {
...
// 设置云主机网卡限速
func SetNicQoS(vmInstance model.SetNicQoSRequest) models.Result[any] {
	//PUT zstack/v1/vm-instances/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/vm-instances/%s/actions", vmInstance.Uuid)
...
// 获取云主机网卡限速
func GetNicQoS(vmInstance model.GetNicQoSRequest) models.Result[any] {
...
// 取消云主机网卡限速
func DeleteNicQoS(vmInstance model.DeleteNicQoSRequest) models.Result[any] {
...
// 获取相互依赖的镜像和L3网络
func GetInterdependentL3NetworksImages(vmInstance model.GetInterdependentL3NetworksImagesRequest) models.Result[any] {
...
// 设置云主机SSH Key
func SetVmSshKey(vmInstance model.SetVmSshKeyRequest) models.Result[any] {
	//PUT zstack/v1/vm-instances/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/vm-instances/%s/actions", vmInstance.Uuid)
...
// 获取云主机SSH Key
func GetVmSshKey(vmInstance model.GetVmSshKeyRequest) models.Result[any] {
...
// 删除云主机SSH Key
func DeleteVmSshKey(vmInstance model.DeleteVmSshKeyRequest) models.Result[any] {
...
// 变更云主机密码
func ChangeVmPassword(vmInstance model.ChangeVmPasswordRequest) models.Result[any] {
	//PUT zstack/v1/vm-instances/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/vm-instances/%s/actions", vmInstance.Uuid)
...
// 设置云主机控制台密码
func SetVmConsolePassword(vmInstance model.SetVmConsolePasswordRequest) models.Result[any] {
	//PUT zstack/v1/vm-instances/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/vm-instances/%s/actions", vmInstance.Uuid)
...
// 获取云主机控制台密码
func GetVmConsolePassword(vmInstance model.GetVmConsolePasswordRequest) models.Result[any] {
...
// 删除云主机控制台密码
func DeleteVmConsolePassword(vmInstance model.DeleteVmConsolePasswordRequest) models.Result[any] {
...
// 获取云主机控制台地址和访问协议
func GetVmConsoleAddress(vmInstance model.GetVmConsoleAddressRequest) models.Result[any] {
...
// 设置云主机Hostname
func SetVmHostname(vmInstance model.SetVmHostnameRequest) models.Result[any] {
	//PUT zstack/v1/vm-instances/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/vm-instances/%s/actions", vmInstance.Uuid)
...
// 获取云主机Hostname
func GetVmHostname(vmInstance model.GetVmHostnameRequest) models.Result[any] {
...
// 删除云主机Hostname
func DeleteVmHostname(vmInstance model.DeleteVmHostnameRequest) models.Result[any] {
...
// 创建启动云主机的定时任务
func CreateStartVmInstanceScheduler(vmInstance model.CreateStartVmInstanceSchedulerRequest) models.Result[any] {
...
// 创建停止云主机的定时任务
func CreateStopVmInstanceScheduler(vmInstance model.CreateStopVmInstanceSchedulerRequest) models.Result[any] {
...
// 创建重启云主机的定时任务
func CreateRebootVmInstanceScheduler(vmInstance model.CreateRebootVmInstanceSchedulerRequest) models.Result[any] {
...
// 获取云主机启动设备列表
func GetVmBootOrder(vmInstance model.GetVmBootOrderRequest) models.Result[any] {
...
// 指定云主机启动设备
func SetVmBootOrder(vmInstance model.SetVmBootOrderRequest) models.Result[any] {
	//PUT zstack/v1/vm-instances/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/vm-instances/%s/actions", vmInstance.Uuid)
...
// 获取目的地列表
func GetCandidateZonesClustersHostsForCreatingVm(vmInstance model.GetCandidateZonesClustersHostsForCreatingVmRequest) models.Result[any] {
...
// 获取云主机可启动目的地列表
func GetVmStartingCandidateClustersHosts(vmInstance model.GetVmStartingCandidateClustersHostsRequest) models.Result[any] {
...
// 指定云主机IP
func SetVmStaticIp(vmInstance model.SetVmStaticIpRequest) models.Result[any] {
	//PUT zstack/v1/vm-instances/{vmInstanceUuid}/actions
	url := fmt.Sprintf("zstack/v1/vm-instances/%s/actions", vmInstance.VmInstanceUuid)
...
// 删除云主机指定IP
func DeleteVmStaticIp(vmInstance model.DeleteVmStaticIpRequest) models.Result[any] {
...
// 获取云主机能力
func GetVmCapabilities(vmInstance model.GetVmCapabilitiesRequest) models.Result[any] {
...
// 更新云主机信息
func UpdateVmInstance(vmInstance model.UpdateVmInstanceRequest) models.Result[any] {
	//PUT zstack/v1/vm-instances/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/vm-instances/%s/actions", vmInstance.UUID)
...
// 克隆云主机到指定物理机
func CloneVmInstance(vmInstance model.CloneVmInstanceRequest) models.Result[any] {
	//PUT zstack/v1/vm-instances/{vmInstanceUuid}/actions
	url := fmt.Sprintf("zstack/v1/vm-instances/%s/actions", vmInstance.VmInstanceUuid)
...
// 设置云主机时钟同步
func SetVmClockTrack(vmInstance model.SetVmClockTrackRequest) models.Result[any] {
	//PUT zstack/v1/vm-instances/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/vm-instances/%s/actions", vmInstance.UUID)
...
// 设置云主机高可用级别
func SetVmInstanceHaLevel(vmInstance model.SetVmInstanceHaLevelRequest) models.Result[any] {
...
// 获取云主机高可用级别
func GetVmInstanceHaLevel(vmInstance model.GetVmInstanceHaLevelRequest) models.Result[any] {
...
// 取消云主机高可用
func DeleteVmInstanceHaLevel(vmInstance model.DeleteVmInstanceHaLevelRequest) models.Result[any] {
...
// 获取云主机Qga
func GetVmQga(vmInstance model.GetVmQgaRequest) models.Result[any] {
...
// 设置云主机Qga
func SetVmQga(vmInstance model.SetVmQgaRequest) models.Result[any] {
	//PUT zstack/v1/vm-instances/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/vm-instances/%s/actions", vmInstance.UUID)
...
// 获取云主机RDP开关状态
func GetVmRDP(vmInstance model.GetVmRDPRequest) models.Result[any] {
...
// 设置云主机RDP开关状态
func SetVmRDP(vmInstance model.SetVmRDPRequest) models.Result[any] {
	//PUT zstack/v1/vm-instances/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/vm-instances/%s/actions", vmInstance.UUID)
...
// 获取云主机支持的屏幕数
func GetVmMonitorNumber(vmInstance model.GetVmMonitorNumberRequest) models.Result[any] {
...
// 设置云主机支持的屏幕数
func SetVmMonitorNumber(vmInstance model.SetVmMonitorNumberRequest) models.Result[any] {
	//PUT zstack/v1/vm-instances/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/vm-instances/%s/actions", vmInstance.UUID)
...
// 修改云主机根云盘
func ChangeVmImage(vmInstance model.ChangeVmImageRequest) models.Result[any] {
	//PUT zstack/v1/vm-instances/{vmInstanceUuid}/actions
	url := fmt.Sprintf("zstack/v1/vm-instances/%s/actions", vmInstance.VmInstanceUuid)
...
// 获取候选镜像列表
func GetImageCandidatesForVmToChange(vmInstance model.GetImageCandidatesForVmToChangeRequest) models.Result[any] {
...
// 更新云主机mac地址
func UpdateVmNicMac(vmInstance model.UpdateVmNicMacRequest) models.Result[any] {
...
// 设置云主机防IP欺骗启用状态
func SetVmCleanTraffic(vmInstance model.SetVmCleanTrafficRequest) models.Result[any] {
	//PUT zstack/v1/vm-instances/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/vm-instances/%s/actions", vmInstance.Uuid)
...
// 为云主机创建CDROM
func CreateVmCdRom(vmInstance model.CreateVmCdRomRequest) models.Result[any] {
...
// 删除CDROM
func DeleteVmCdRom(vmInstance model.DeleteVmCdRomRequest) models.Result[any] {
...
// 修改CDROM
func UpdateVmCdRom(params model.UpdateVmCdRomRequest) models.Result[any] {
...
// 设置云主机默认CDROM
func SetVmInstanceDefaultCdRom(vmInstance model.SetVmInstanceDefaultCdRomRequest) models.Result[any] {
...
// 查询CDROM清单
func QueryVmCdRom(vmInstance model.QueryVmCdRomRequest) models.Result[any] {
...
// 更改云主机优先级级别
func UpdateVmPriority(vmInstance model.UpdateVmPriorityRequest) models.Result[any] {
	//PUT zstack/v1/vm-instances/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/vm-instances/%s/actions", vmInstance.Uuid)
...
// 设置云主机显存
func SetVmQxlMemory(vmInstance model.SetVmQxlMemoryRequest) models.Result[any] {
	//PUT zstack/v1/vm-instances/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/vm-instances/%s/actions", vmInstance.Uuid)
...
// 设置云主机虚拟声卡类型
func SetVmSoundType(vmInstance model.SetVmSoundTypeRequest) models.Result[any] {
	//PUT zstack/v1/vm-instances/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/vm-instances/%s/actions", vmInstance.Uuid)
...
// 获取spice的CA证书
func GetSpiceCertificates(vmInstance model.GetSpiceCertificatesRequest) models.Result[any] {
...
// 为云主机加载增强工具镜像
func AttachGuestToolsIsoToVm(vmInstance model.AttachGuestToolsIsoToVmRequest) models.Result[any] {
	//PUT zstack/v1/vm-instances/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/vm-instances/%s/actions", vmInstance.Uuid)
...
// 获取云主机可用的最新增强工具
func GetLatestGuestToolsForVm(vmInstance model.GetLatestGuestToolsForVmRequest) models.Result[any] {
...
// 获取云主机内部增强工具的信息
func GetVmGuestToolsInfo(vmInstance model.GetVmGuestToolsInfoRequest) models.Result[any] {
...
// 获取云主机第一启动项
func GetVmInstanceFirstBootDevice(vmInstance model.GetVmInstanceFirstBootDeviceRequest) models.Result[any] {
...
// 设置网卡型号
func UpdateVmNicDriver(vmInstance model.UpdateVmNicDriverRequest) models.Result[any] {
...
// 获取云主机设备地址
func GetVmDeviceAddress(vmInstance model.GetVmDeviceAddressRequest) models.Result[any] {
...
// 批量获取云主机能力
func GetVmsCapabilities(vmInstance model.GetVmsCapabilitiesRequest) models.Result[any] {
...
// 设置云主机vNUMA
func SetVmNuma(vmInstance model.SetVmNumaRequest) models.Result[any] {
	//PUT zstack/v1/vm-instances/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/vm-instances/%s/actions", vmInstance.UUID)
...
// 获取VM Numa开关状态
func GetVmNuma(vmInstance model.GetVmNumaRequest) models.Result[any] {
...
// 查询云主机的vNUMA拓扑信息
func GetVmvNUMATopology(vmInstance model.GetVmvNUMATopologyRequest) models.Result[any] {
...
func SetVmEmulatorPinning(vmInstance model.SetVmEmulatorPinningRequest) models.Result[any] {
	//PUT zstack/v1/vm-instances/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/vm-instances/%s/actions", vmInstance.UUID)
...
func GetVmEmulatorPinning(vmInstance model.GetVmEmulatorPinningRequest) models.Result[any] {
