...
// 创建流量监控搜集器
func CreateFlowCollector(params model.CreateFlowCollectorRequest) models.Result[any] {
...
// 查询流量监控的搜集器
func QueryFlowCollector(params model.QueryFlowCollectorRequest) models.Result[any] {
...
// 更新搜集器信息
func UpdateFlowCollector(params model.UpdateFlowCollectorRequest) models.Result[any] {
...
// 删除流量监控搜集器
func DeleteFlowCollector(params model.DeleteFlowCollectorRequest) models.Result[any] {
...
// 创建流量监控资源
func CreateFlowMeter(params model.CreateFlowMeterRequest) models.Result[any] {
...
// 查询流量监控资源
func QueryFlowMeter(params model.QueryFlowMeterRequest) models.Result[any] {
...
// 更新流量监控的信息
func UpdateFlowMeter(params model.UpdateFlowMeterRequest) models.Result[any] {
...
// 删除流量监控资源
func DeleteFlowMeter(params model.DeleteFlowMeterRequest) models.Result[any] {
...
func AddVRouterNetworksToFlowMeter(params model.AddVRouterNetworksToFlowMeterRequest) models.Result[any] {
...
// 查询开启流量监控的VPC网络
func QueryVRouterFlowMeterNetwork(params model.QueryVRouterFlowMeterNetworkRequest) models.Result[any] {
...
// 流量监控的统计信息
func GetVRouterFlowCounter(params model.GetVRouterFlowCounterRequest) models.Result[any] {
...
// 清除VPC路由器网络的流量监控
func RemoveVRouterNetworksFromFlowMeter(params model.RemoveVRouterNetworksFromFlowMeterRequest) models.Result[any] {
...
// 获取流量监控协议中使用的系统标识
func GetFlowMeterRouterId(params model.GetFlowMeterRouterIdRequest) models.Result[any] {
...
// 设置流量监控协议使用的VPC标识
func SetFlowMeterRouterId(params model.SetFlowMeterRouterIdRequest) models.Result[any] {
