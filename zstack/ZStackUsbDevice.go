...
// 获取云主机usb重定向开关状态
func GetVmUsbRedirect(params model.GetVmUsbRedirectRequest) models.Result[any] {
...
// 设置云主机usb重定向开关
func SetVmUsbRedirect(params model.SetVmUsbRedirectRequest) models.Result[any] {
...
// 云主机加载物理机USB设备
func AttachUsbDeviceToVm(params model.AttachUsbDeviceToVmRequest) models.Result[any] {
...
// 将云主机挂载的USB设备卸载
func DetachUsbDeviceFromVm(params model.DetachUsbDeviceFromVmRequest) models.Result[any] {
...
// 获取USB透传候选列表
func GetUsbDeviceCandidatesForAttachingVm(params model.GetUsbDeviceCandidatesForAttachingVmRequest) models.Result[any] {
...
// 查询USB设备
func QueryUsbDevice(params model.QueryUsbDeviceRequest) models.Result[any] {
...
// 更新USB设备
func UpdateUsbDevice(params model.UpdateUsbDeviceRequest) models.Result[any] {
