...
// 获取网络服务类型
func GetNetworkServiceTypes(params model.GetNetworkServiceTypesRequest) models.Result[any] {
...
// 查询网络服务模块
func QueryNetworkServiceProvider(params model.QueryNetworkServiceProviderRequest) models.Result[any] {
...
// 查询网络服务与三层网络引用
func QueryNetworkServiceL3NetworkRef(params model.QueryNetworkServiceL3NetworkRefRequest) models.Result[any] {
...
// 挂载网络服务到三层网络
func AttachNetworkServiceToL3Network(params model.AttachNetworkServiceToL3NetworkRequest) models.Result[any] {
...
// 从三层网络卸载网络服务
func DetachNetworkServiceFromL3Network(params model.DetachNetworkServiceFromL3NetworkRequest) models.Result[any] {
