...
// 创建弹性伸缩组
func CreateAutoScalingGroup(params model.CreateAutoScalingGroupRequest) models.Result[any] {
...
// 删除弹性伸缩组
func DeleteAutoScalingGroup(params model.DeleteAutoScalingGroupRequest) models.Result[any] {
...
// 修改弹性伸缩组
func UpdateAutoScalingGroup(params model.UpdateAutoScalingGroupRequest) models.Result[any] {
...
// 查询弹性伸缩组
func QueryAutoScalingGroup(params model.QueryAutoScalingGroupRequest) models.Result[any] {
...
// 查询弹性伸缩组活动列表
func QueryAutoScalingGroupActivity(params model.QueryAutoScalingGroupActivityRequest) models.Result[any] {
...
// 创建伸缩组云主机扩容规则
func CreateAutoScalingGroupAddingNewInstanceRule(params model.CreateAutoScalingGroupAddingNewInstanceRuleRequest) models.Result[any] {
...
// 创建伸缩组云主机缩容规则
func CreateAutoScalingGroupRemovalInstanceRule(params model.CreateAutoScalingGroupRemovalInstanceRuleRequest) models.Result[any] {
...
// 删除伸缩规则
func DeleteAutoScalingRule(params model.DeleteAutoScalingRuleRequest) models.Result[any] {
...
// 修改弹性伸缩组规则
func UpdateAutoScalingRule(params model.UpdateAutoScalingRuleRequest) models.Result[any] {
...
// 修改伸缩组扩容规则
func UpdateAutoScalingGroupAddingNewInstanceRule(params model.UpdateAutoScalingGroupAddingNewInstanceRuleRequest) models.Result[any] {
...
// 修改伸缩组缩容规则
func UpdateAutoScalingGroupRemovalInstanceRule(params model.UpdateAutoScalingGroupRemovalInstanceRuleRequest) models.Result[any] {
...
// 查询伸缩规则
func QueryAutoScalingRule(params model.QueryAutoScalingRuleRequest) models.Result[any] {
...
// 创建伸缩规则触发器
func CreateAutoScalingRuleAlarmTrigger(params model.CreateAutoScalingRuleAlarmTriggerRequest) models.Result[any] {
...
// 创建伸缩规则定时任务触发器
func CreateAutoScalingRuleSchedulerJobTrigger(params model.CreateAutoScalingRuleSchedulerJobTriggeRequest) models.Result[any] {
...
// 删除伸缩规则触发器
func DeleteAutoScalingRuleTrigger(params model.DeleteAutoScalingRuleTriggerRequest) models.Result[any] {
...
// 查询伸缩规则触发器列表
func QueryAutoScalingRuleTrigger(params model.QueryAutoScalingRuleTriggerRequest) models.Result[any] {
...
// 创建伸缩组云主机模块
func CreateAutoScalingVmTemplate(params model.CreateAutoScalingVmTemplateRequest) models.Result[any] {
...
// 将云主机模块添加到弹性伸缩组
func AttachAutoScalingTemplateToGroup(params model.AttachAutoScalingTemplateToGroupRequest) models.Result[any] {
...
// 删除伸缩组模板
func DeleteAutoScalingTemplate(params model.DeleteAutoScalingTemplateRequest) models.Result[any] {
...
// 卸载伸缩组模板
func DetachAutoScalingTemplateFromGroup(params model.DetachAutoScalingTemplateFromGroupRequest) models.Result[any] {
...
// 查询伸缩组云主机模板
func QueryAutoScalingVmTemplate(params model.QueryAutoScalingVmTemplateRequest) models.Result[any] {
...
// 手动删除弹性伸缩组内云主机
func DeleteAutoScalingGroupInstance(params model.DeleteAutoScalingGroupInstanceRequest) models.Result[any] {
...
// 查询弹性伸缩组内云主机列表
func QueryAutoScalingGroupInstance(params model.QueryAutoScalingGroupInstanceRequest) models.Result[any] {
...
// 修改弹性伸缩组启用状态
func ChangeAutoScalingGroupState(params model.ChangeAutoScalingGroupStateRequest) models.Result[any] {
	//PUT zstack/v1/autoscaling/groups/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/autoscaling/groups/%s/actions", params.Uuid)
...
// 手动执行伸缩组规则
func ExecuteAutoScalingRule(params model.ExecuteAutoScalingRuleRequest) models.Result[any] {
	//PUT zstack/v1/autoscaling/rules/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/autoscaling/rules/%s/actions", params.Uuid)
...
// 更新伸缩组实例信息
func UpdateAutoScalingGroupInstance(params model.UpdateAutoScalingGroupInstanceRequest) models.Result[any] {
...
// 更新伸缩组云主机模板
func UpdateAutoScalingVmTemplate(params model.UpdateAutoScalingVmTemplateRequest) models.Result[any] {
