...
// 创建云盘
func CreateDataVolume(params model.CreateDataVolumeRequest) models.Result[any] {
...
// 删除云盘
func DeleteDataVolume(params model.DeleteDataVolumeRequest) models.Result[any] {
...
// 彻底删除云盘
func ExpungeDataVolume(params model.ExpungeDataVolumeRequest) models.Result[any] {
...
// 恢复云盘
func RecoverDataVolume(params model.RecoverDataVolumeRequest) models.Result[any] {
	//PUT zstack/v1/volumes/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/volumes/%s/actions", params.Uuid)
	dataStr, err := request.Put(url, params)
	if err != nil {
...
// 开启或关闭云盘
func ChangeVolumeState(params model.ChangeVolumeStateRequest) models.Result[any] {
	//PUT zstack/v1/volumes/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/volumes/%s/actions", params.Uuid)
	dataStr, err := request.Put(url, params)
	if err != nil {
...
// 从镜像创建云盘
func CreateDataVolumeFromVolumeTemplate(params model.CreateDataVolumeFromVolumeTemplateRequest) models.Result[any] {
...
// 从快照创建云盘
func CreateDataVolumeFromVolumeSnapshot(params model.CreateDataVolumeFromVolumeSnapshotRequest) models.Result[any] {
...
// 获取云盘格式
func GetVolumeFormat(params model.GetVolumeFormatRequest) models.Result[any] {
...
// 获取云盘支持的类型的能力
func GetVolumeCapabilities(params model.GetVolumeCapabilitiesRequest) models.Result[any] {
	//GET zstack/v1/volumes/formats
	url := fmt.Sprintf("zstack/v1/volumes/formats")
	dataStr, err := request.Get(url, params)
	if err != nil {
...
// 同步云盘大小
func SyncVolumeSize(params model.SyncVolumeSizeRequest) models.Result[any] {
	//PUT zstack/v1/volumes/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/volumes/%s/actions", params.Uuid)
	dataStr, err := request.Put(url, params)
	if err != nil {
...
// 扩展根云盘
func ResizeRootVolume(params model.ResizeRootVolumeRequest) models.Result[any] {
...
// 扩展数据云盘
func ResizeDataVolume(params model.ResizeDataVolumeRequest) models.Result[any] {
...
// 设置云盘限速
func SetVolumeQoS(params model.SetVolumeQoSRequest) models.Result[any] {
	//PUT zstack/v1/volumes/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/volumes/%s/actions", params.Uuid)
	dataStr, err := request.Put(url, params)
	if err != nil {
...
// 获取云盘限速
func GetVolumeQoS(params model.GetVolumeQoSRequest) models.Result[any] {
...
// 取消云盘网卡限速
func DeleteVolumeQoS(params model.DeleteVolumeQoSRequest) models.Result[any] {
...
// 获取云盘可被加载的云主机列表
func GetDataVolumeAttachableVm(params model.GetDataVolumeAttachableVmRequest) models.Result[any] {
...
// 挂载云盘到云主机上
func AttachDataVolumeToVm(params model.AttachDataVolumeToVmRequest) models.Result[any] {
...
// 从云主机上卸载云盘
func DetachDataVolumeFromVm(params model.DetachDataVolumeFromVmRequest) models.Result[any] {
...
// 查询云盘快照
func QueryVolumeSnapshot(params model.QueryVolumeSnapshotRequest) models.Result[any] {
...
// 查询快照树
func QueryVolumeSnapshotTree(params model.QueryVolumeSnapshotTreeRequest) models.Result[any] {
...
// 更新云盘快照信息
func UpdateVolumeSnapshot(params model.UpdateVolumeSnapshotRequest) models.Result[any] {
...
// 将云盘回滚至指定快照
func RevertVolumeFromSnapshot(params model.RevertVolumeFromSnapshotRequest) models.Result[any] {
	//PUT zstack/v1/volume-snapshots/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/volume-snapshots/%s/actions", params.Uuid)
	dataStr, err := request.Put(url, params)
	if err != nil {
...
// 获取快照容量
func GetVolumeSnapshotSize(params model.GetVolumeSnapshotSizeRequest) models.Result[any] {
	//PUT zstack/v1/volume-snapshots/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/volume-snapshots/%s/actions", params.Uuid)
	dataStr, err := request.Put(url, params)
	if err != nil {
...
// 快照瘦身
func ShrinkVolumeSnapshot(params model.ShrinkVolumeSnapshotRequest) models.Result[any] {
