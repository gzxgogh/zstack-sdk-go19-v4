...
// 创建端口转发规则
func CreatePortForwardingRule(params model.CreatePortForwardingRuleRequest) models.Result[any] {
...
// 删除端口转发规则
func DeletePortForwardingRule(params model.DeletePortForwardingRuleRequest) models.Result[any] {
...
// 查询端口转发规则
func QueryPortForwardingRule(params model.QueryPortForwardingRuleRequest) models.Result[any] {
...
// 更新端口转发规则
func UpdatePortForwardingRule(params model.UpdatePortForwardingRuleRequest) models.Result[any] {
...
// 改变端口转发规则的状态
func ChangePortForwardingRuleState(params model.ChangePortForwardingRuleStateRequest) models.Result[any] {
	//PUT zstack/v1/port-forwarding/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/port-forwarding/%s/actions", params.UUID)
...
// 获取云主机网卡列表
func GetPortForwardingAttachableVmNics(params model.GetPortForwardingAttachableVmNicsRequest) models.Result[any] {
...
// 挂载规则到虚拟机网卡上
func AttachPortForwardingRule(params model.AttachPortForwardingRuleRequest) models.Result[any] {
...
// 从虚拟机网卡卸载规则
func DetachPortForwardingRule(params model.DetachPortForwardingRuleRequest) models.Result[any] {
