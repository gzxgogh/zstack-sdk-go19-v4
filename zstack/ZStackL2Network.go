...
// 创建VXLAN网络池
func CreateL2VxlanNetworkPool(params model.CreateL2VxlanNetworkPoolRequest) models.Result[any] {
...
// 查询VXLAN网络池
func QueryL2VxlanNetworkPool(params model.QueryL2VxlanNetworkPoolRequest) models.Result[any] {
...
// 创建VXLAN网络池
func CreateL2VxlanNetwork(params model.CreateL2VxlanNetworkRequest) models.Result[any] {
...
// 查询VXLAN网络
func QueryL2VxlanNetwork(params model.QueryL2VxlanNetworkRequest) models.Result[any] {
...
// 创建普通二层网络
func CreateL2NoVlanNetwork(params model.CreateL2NoVlanNetworkRequest) models.Result[any] {
...
// 创建二层VLAN网络
func CreateL2VlanNetwork(params model.CreateL2VlanNetworkRequest) models.Result[any] {
...
// 查询二层VLAN网络
func QueryL2VlanNetwork(params model.QueryL2VlanNetworkRequest) models.Result[any] {
...
// 删除二层网络
func DeleteL2Network(params model.DeleteL2NetworkRequest) models.Result[any] {
...
// 查询二层网络
func QueryL2Network(params model.QueryL2NetworkRequest) models.Result[any] {
...
// 更新二层网络
func UpdateL2Network(params model.UpdateL2NetworkRequest) models.Result[any] {
...
// 获取二层网络类型
func GetL2NetworkTypes(params model.GetL2NetworkTypesRequest) models.Result[any] {
...
// 挂载二层网络到集群
func AttachL2NetworkToCluster(params model.AttachL2NetworkToClusterRequest) models.Result[any] {
...
// 从集群上卸载二层网络
func DetachL2NetworkFromCluster(params model.DetachL2NetworkFromClusterRequest) models.Result[any] {
...
// 创建Vni Range
func CreateVniRange(params model.CreateVniRangeRequest) models.Result[any] {
...
// 查询Vni Range
func QueryVniRange(params model.QueryVniRangeRequest) models.Result[any] {
...
// 删除Vni  Range
func DeleteVniRange(params model.DeleteVniRangeRequest) models.Result[any] {
...
// 修改Vni  Range
func UpdateVniRange(params model.UpdateVniRangeRequest) models.Result[any] {
