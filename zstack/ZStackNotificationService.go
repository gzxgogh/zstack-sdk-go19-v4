...
// 创建主题
func CreateSNSTopic(params model.CreateSNSTopicRequest) models.Result[any] {
...
// 删除主题
func DeleteSNSTopic(params model.DeleteSNSTopicRequest) models.Result[any] {
...
// 更改主题状态
func ChangeSNSTopicState(params model.ChangeSNSTopicStateRequest) models.Result[any] {
...
// 更新主题
func UpdateSNSTopic(params model.UpdateSNSTopicRequest) models.Result[any] {
...
// 查询主题
func QuerySNSTopic(params model.QuerySNSTopicRequest) models.Result[any] {
...
// 创建邮件服务器
func CreateSNSEmailPlatform(params model.CreateSNSEmailPlatformRequest) models.Result[any] {
...
// 测试邮件服务器
func ValidateSNSEmailPlatform(params model.ValidateSNSEmailPlatformRequest) models.Result[any] {
...
// 删除SNS应用平台
func DeleteSNSApplicationPlatform(params model.DeleteSNSApplicationPlatformRequest) models.Result[any] {
...
// 查询邮件服务器
func QuerySNSEmailPlatform(params model.QuerySNSEmailPlatformRequest) models.Result[any] {
...
// 更新SNS应用平台
func UpdateSNSApplicationPlatform(params model.UpdateSNSApplicationPlatformRequest) models.Result[any] {
...
// 查询SNS应用平台
func QuerySNSApplicationPlatform(params model.QuerySNSApplicationPlatformRequest) models.Result[any] {
...
// 更改SNS应用平台状态
func ChangeSNSApplicationPlatformState(params model.ChangeSNSApplicationPlatformStateRequest) models.Result[any] {
	//PUT zstack/v1/sns/application-platforms/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/sns/application-platforms/%s/actions", params.UUID)
...
// 创建邮件接收端
func CreateSNSEmailEndpoint(params model.CreateSNSEmailEndpointRequest) models.Result[any] {
...
// 查询邮件接收端
func QuerySNSEmailEndpoint(params model.QuerySNSEmailEndpointRequest) models.Result[any] {
...
// 创建HTTP接收端
func CreateSNSHttpEndpoint(params model.CreateSNSHttpEndpointRequest) models.Result[any] {
...
// 查询HTTP接收端
func QuerySNSHttpEndpoint(params model.QuerySNSHttpEndpointRequest) models.Result[any] {
...
// 创建钉钉接收端
func CreateSNSDingTalkEndpoint(params model.CreateSNSDingTalkEndpointRequest) models.Result[any] {
...
// 添加钉钉用户
func AddSNSDingTalkAtPerson(params model.AddSNSDingTalkAtPersonRequest) models.Result[any] {
...
// 删除钉钉用户
func RemoveSNSDingTalkAtPerson(params model.RemoveSNSDingTalkAtPersonRequest) models.Result[any] {
...
// 查询钉钉终端
func QuerySNSDingTalkEndpoint(params model.QuerySNSDingTalkEndpointRequest) models.Result[any] {
...
// 删除接收端
func DeleteSNSApplicationEndpoint(params model.DeleteSNSApplicationEndpointRequest) models.Result[any] {
...
// 更新接收端
func UpdateSNSApplicationEndpoint(params model.UpdateSNSApplicationEndpointRequest) models.Result[any] {
...
// 查询接收端
func QuerySNSApplicationEndpoint(params model.QuerySNSApplicationEndpointRequest) models.Result[any] {
...
// 更改接收端
func ChangeSNSApplicationEndpointState(params model.ChangeSNSApplicationEndpointStateRequest) models.Result[any] {
	//PUT zstack/v1/sns/application-endpoints/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/sns/application-endpoints/%s/actions", params.UUID)
...
// 创建阿里云短信接收端
func CreateSNSAliyunSmsEndpoint(params model.CreateSNSAliyunSmsEndpointRequest) models.Result[any] {
...
// 验证阿里云短信接收端
func ValidateSNSAliyunSmsEndpoint(params model.ValidateSNSAliyunSmsEndpointRequest) models.Result[any] {
...
// 添加短信接收者
func AddSNSSmsReceiver(params model.AddSNSSmsReceiverRequest) models.Result[any] {
...
// 删除短信接收者
func RemoveSNSSmsReceiver(params model.RemoveSNSSmsReceiverRequest) models.Result[any] {
...
// 查询短信接收端
func QuerySNSSmsEndpoint(params model.QuerySNSSmsEndpointRequest) models.Result[any] {
...
// 添加邮箱地址到邮箱接收端
func AddEmailAddressToSNSEmailEndpoint(params model.AddEmailAddressToSNSEmailEndpointRequest) models.Result[any] {
...
// 更新接收端邮箱地址
func UpdateEmailAddressOfSNSEmailEndpoint(params model.UpdateEmailAddressOfSNSEmailEndpointRequest) models.Result[any] {
...
// 删除邮箱接收端的地址
func DeleteEmailAddressOfSNSEmailEndpoint(params model.DeleteEmailAddressOfSNSEmailEndpointRequest) models.Result[any] {
...
// 查询接收端邮箱地址
func QuerySNSEmailAddress(params model.QuerySNSEmailAddressRequest) models.Result[any] {
...
// 创建微软Teams接收端
func CreateSNSMicrosoftTeamsEndpointRequest(params model.CreateSNSMicrosoftTeamsEndpointRequest) models.Result[any] {
...
// 查询微软Teams接收端
func QuerySNSMicrosoftTeamsEndpoint(params model.QuerySNSMicrosoftTeamsEndpointRequest) models.Result[any] {
...
// 订阅主题
func SubscribeSNSTopic(params model.SubscribeSNSTopicRequest) models.Result[any] {
...
// 查询订阅主题的终端
func QuerySNSTopicSubscriber(params model.QuerySNSTopicSubscriberRequest) models.Result[any] {
...
// 退订主题
func UnsubscribeSNSTopic(params model.UnsubscribeSNSTopicRequest) models.Result[any] {
...
// 获取管理节点目录容量
func GetManagementNodeDirCapacity(params model.GetManagementNodeDirCapacityRequest) models.Result[any] {
