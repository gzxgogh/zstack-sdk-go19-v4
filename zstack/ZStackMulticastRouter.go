...
// 创建组播路由器
func CreateMulticastRouter(params model.CreateMulticastRouterRequest) models.Result[any] {
...
// 删除组播路由器
func DeleteMulticastRouter(params model.DeleteMulticastRouterRequest) models.Result[any] {
...
// 查询组播路由器
func QueryMulticastRouter(params model.QueryMulticastRouterRequest) models.Result[any] {
...
// 改变组播路由器状态
func ChangeMulticastRouterState(params model.ChangeMulticastRouterStateRequest) models.Result[any] {
...
// 获取组播路由表
func GetVpcMulticastRoute(params model.GetVpcMulticastRouteRequest) models.Result[any] {
...
// 添加组播路由静态RP地址
func AddRendezvousPointToMulticastRouter(params model.AddRendezvousPointToMulticastRouterRequest) models.Result[any] {
...
// 删除组播路由器静态RP地址
func RemoveRendezvousPointFromMulticastRouter(params model.RemoveRendezvousPointFromMulticastRouterRequest) models.Result[any] {
