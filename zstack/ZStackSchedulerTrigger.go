...
// 创建定时器
func CreateSchedulerTrigger(params model.CreateSchedulerTriggerRequest) models.Result[any] {
...
// 查询定时器
func QuerySchedulerTrigger(params model.QuerySchedulerTriggerRequest) models.Result[any] {
...
// 更新定时器
func UpdateSchedulerTrigger(params model.UpdateSchedulerTriggerRequest) models.Result[any] {
...
// 添加定时任务到定时器
func AddSchedulerJobToSchedulerTrigger(params model.AddSchedulerJobToSchedulerTriggerRequest) models.Result[any] {
...
// 从定时器移除定时任务
func RemoveSchedulerJobFromSchedulerTrigger(params model.RemoveSchedulerJobFromSchedulerTriggerRequest) models.Result[any] {
...
// 创建定时任务
func CreateSchedulerJob(params model.CreateSchedulerJobRequest) models.Result[any] {
...
// 删除定时任务
func DeleteSchedulerJob(params model.DeleteSchedulerJobRequest) models.Result[any] {
...
// 查询定时任务
func QuerySchedulerJob(params model.QuerySchedulerJobRequest) models.Result[any] {
...
// 更新定时任务
func UpdateSchedulerJob(params model.UpdateSchedulerJobRequest) models.Result[any] {
...
// 获取未挂载定时器的任务
func GetNoTriggerSchedulerJobs(params model.GetNoTriggerSchedulerJobsRequest) models.Result[any] {
...
// 改变定时任务状态
func ChangeSchedulerState(params model.ChangeSchedulerStateRequest) models.Result[any] {
