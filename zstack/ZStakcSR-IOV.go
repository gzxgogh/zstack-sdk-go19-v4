...
// L3网络中是否存在可用VF网卡
func IsVfNicAvailableInL3Network(params model.IsVfNicAvailableInL3NetworkRequest) models.Result[any] {
...
// 修改云主机网卡类型
func ChangeVmNicType(params model.ChangeVmNicTypeRequest) models.Result[any] {
