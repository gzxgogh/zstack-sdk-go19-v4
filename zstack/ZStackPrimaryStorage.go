...
// 删除主存储
func DeletePrimaryStorage(params model.DeletePrimaryStorageRequest) models.Result[any] {
...
// 查询物理机
func QueryPrimaryStorage(params model.QueryPrimaryStorageRequest) models.Result[any] {
...
// 向集群添加主存储
func AttachPrimaryStorageToCluster(params model.AttachPrimaryStorageToClusterRequest) models.Result[any] {
...
// 从集群卸载主存储
func DetachPrimaryStorageFromCluster(params model.DetachPrimaryStorageFromClusterRequest) models.Result[any] {
...
// 重连主存储
func ReconnectPrimaryStorage(params model.ReconnectPrimaryStorageRequest) models.Result[any] {
...
// 获取主存储容量
func GetPrimaryStorageCapacity(params model.GetPrimaryStorageCapacityRequest) models.Result[any] {
...
// 刷新主存储容量
func SyncPrimaryStorageCapacity(params model.SyncPrimaryStorageCapacityRequest) models.Result[any] {
...
// 更改主存储状态
func ChangePrimaryStorageState(params model.ChangePrimaryStorageStateRequest) models.Result[any] {
	//PUT zstack/v1/primary-storage/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/primary-storage/%s/actions", params.Uuid)
...
// 更新主存储信息
func UpdatePrimaryStorage(params model.UpdatePrimaryStorageRequest) models.Result[any] {
	//PUT zstack/v1/primary-storage/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/primary-storage/%s/actions", params.Uuid)
...
// 清除主存储镜像缓存
func CleanUpImageCacheOnPrimaryStorage(params model.CleanUpImageCacheOnPrimaryStorageRequest) models.Result[any] {
	//PUT zstack/v1/primary-storage/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/primary-storage/%s/actions", params.Uuid)
...
// 获取主存储分配策略清单
func GetPrimaryStorageAllocatorStrategies(params model.GetPrimaryStorageAllocatorStrategiesRequest) models.Result[any] {
...
// 获取主存储类型列表
func GetPrimaryStorageTypes(params model.GetPrimaryStorageTypesRequest) models.Result[any] {
...
// 获取候选列表
func GetPrimaryStorageCandidatesForVolumeMigration(params model.GetPrimaryStorageCandidatesForVolumeMigrationRequest) models.Result[any] {
...
// 获取跨存储迁移可选物理机列表
func GetHostCandidatesForVmMigration(params model.GetHostCandidatesForVmMigrationRequest) models.Result[any] {
...
// 跨主存储迁移云盘
func PrimaryStorageMigrateVolume(params model.PrimaryStorageMigrateVolumeRequest) models.Result[any] {
...
// 跨主存储迁移云主机
func PrimaryStorageMigrateVm(params model.PrimaryStorageMigrateVmRequest) models.Result[any] {
...
// 获取存储迁移候选列表
func GetPrimaryStorageCandidatesForVmMigration(params model.GetPrimaryStorageCandidatesForVmMigrationRequest) models.Result[any] {
...
// 获取主存储的License信息
func GetPrimaryStorageLicenseInfo(params model.GetPrimaryStorageLicenseInfoRequest) models.Result[any] {
...
// 添加本地存储为主存储
func AddLocalPrimaryStorage(params model.AddLocalPrimaryStorageRequest) models.Result[any] {
...
// 查询本地存储资源引用
func QueryLocalStorageResourceRef(params model.QueryLocalStorageResourceRefRequest) models.Result[any] {
...
// 迁移本地存储上存放的云盘
func LocalStorageMigrateVolume(params model.LocalStorageMigrateVolumeRequest) models.Result[any] {
...
// 获取主机本地存储容量
func GetLocalStorageHostDiskCapacity(params model.GetLocalStorageHostDiskCapacityRequest) models.Result[any] {
...
// 获取迁移本地存储物理机
func LocalStorageGetVolumeMigratableHosts(params model.LocalStorageGetVolumeMigratableHostsRequest) models.Result[any] {
...
// 添加NFS主存储
func AddNfsPrimaryStorage(params model.AddNfsPrimaryStorageRequest) models.Result[any] {
...
// 添加一个共享挂载点的主存储
func AddSharedMountPointPrimaryStorage(params model.AddSharedMountPointPrimaryStorageRequest) models.Result[any] {
...
// 添加Ceph主存储
func AddCephPrimaryStorage(params model.AddCephPrimaryStorageRequest) models.Result[any] {
...
// 查询Ceph主存储
func QueryCephPrimaryStorage(params model.QueryCephPrimaryStorageRequest) models.Result[any] {
...
// 为Ceph主存储添加mon节点
func AddMonToCephPrimaryStorage(params model.AddMonToCephPrimaryStorageRequest) models.Result[any] {
...
// 从Ceph主存储删除mon节点
func RemoveMonFromCephPrimaryStorage(params model.RemoveMonFromCephPrimaryStorageRequest) models.Result[any] {
...
// 更新Ceph主存储mon节点
func UpdateCephPrimaryStorageMon(params model.UpdateCephPrimaryStorageMonRequest) models.Result[any] {
...
// 添加Ceph主存储池
func AddCephPrimaryStoragePool(params model.AddCephPrimaryStoragePoolRequest) models.Result[any] {
...
// 删除Ceph主存储池
func DeleteCephPrimaryStoragePool(params model.DeleteCephPrimaryStoragePoolRequest) models.Result[any] {
...
// 查询Ceph主存储池
func QueryCephPrimaryStoragePool(params model.QueryCephPrimaryStoragePoolRequest) models.Result[any] {
...
// 更新Ceph主存储池
func UpdateCephPrimaryStoragePool(params model.UpdateCephPrimaryStoragePoolRequest) models.Result[any] {
...
// 添加Shared Block主存储
func AddSharedBlockGroupPrimaryStorage(params model.AddSharedBlockGroupPrimaryStorageRequest) models.Result[any] {
...
// 查询连接状态
func QuerySharedBlockGroupPrimaryStorageHostRef(params model.QuerySharedBlockGroupPrimaryStorageHostRefRequest) models.Result[any] {
...
// 查询Shared Block主存储
func QuerySharedBlockGroupPrimaryStorage(params model.QuerySharedBlockGroupPrimaryStorageRequest) models.Result[any] {
...
func AddSharedBlockToSharedBlockGroup(params model.AddSharedBlockToSharedBlockGroupRequest) models.Result[any] {
...
// 获取共享块设备候选清单
func GetSharedBlockCandidate(params model.GetSharedBlockCandidateRequest) models.Result[any] {
...
// 刷新共享块设备容量
func RefreshSharedblockDeviceCapacity(params model.RefreshSharedblockDeviceCapacityRequest) models.Result[any] {
...
func UpdateSharedBlockDiskUuid(params model.UpdateSharedBlockDiskUuidRequest) models.Result[any] {
...
// 查询共享块设备
func QuerySharedBlock(params model.QuerySharedBlockRequest) models.Result[any] {
