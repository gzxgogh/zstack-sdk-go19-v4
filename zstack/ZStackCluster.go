...
// 创建一个集群
func CreateCluster(params model.CreateClusterRequest) models.Result[any] {
...
// 删除一个集群
func DeleteCluster(params model.DeleteClusterRequest) models.Result[any] {
...
// 查询集群
func QueryCluster(params model.QueryClusterRequest) models.Result[any] {
...
// 更新集群
func UpdateCluster(params model.UpdateClusterRequest) models.Result[any] {
...
// 改变一个集群的可用状态
func ChangeClusterState(params model.ChangeClusterStateRequest) models.Result[any] {
	//PUT zstack/v1/clusters/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/clusters/%s/actions", params.UUID)
...
// 升级集群内物理机的操作系统
func UpdateClusterOS(params model.UpdateClusterOSRequest) models.Result[any] {
	//PUT zstack/v1/clusters/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/clusters/%s/actions", params.UUID)
