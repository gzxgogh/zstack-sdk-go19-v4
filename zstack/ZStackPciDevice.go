...
// 查询PCI设备
func QueryPciDevice(params model.QueryPciDeviceRequest) models.Result[any] {
...
// 更新PCI设备
func UpdatePciDevice(params model.UpdatePciDeviceRequest) models.Result[any] {
...
// 删除PCI设备
func DeletePciDevice(params model.DeletePciDeviceRequest) models.Result[any] {
...
// 获取PCI设备列表
func GetPciDeviceCandidatesForAttachingVm(params model.GetPciDeviceCandidatesForAttachingVmRequest) models.Result[any] {
...
// 获取可加载PCI设备
func GetPciDeviceCandidatesForNewCreateVm(params model.GetPciDeviceCandidatesForNewCreateVmRequest) models.Result[any] {
...
// 绑定PCI设备到云主机
func AttachPciDeviceToVm(params model.AttachPciDeviceToVmRequest) models.Result[any] {
...
// 卸载PCI设备
func DetachPciDeviceFromVm(params model.DetachPciDeviceFromVmRequest) models.Result[any] {
...
// 创建PCI设备规格
func CreatePciDeviceOffering(params model.CreatePciDeviceOfferingRequest) models.Result[any] {
...
// 删除PCI设备规格
func DeletePciDeviceOffering(params model.DeletePciDeviceOfferingRequest) models.Result[any] {
...
// 查询PCI设备规格信息
func QueryPciDeviceOffering(params model.QueryPciDeviceOfferingRequest) models.Result[any] {
...
// 查询PCI设备规格匹配
func QueryPciDevicePciDeviceOffering(params model.QueryPciDevicePciDeviceOfferingRequest) models.Result[any] {
...
// 获取物理机Iommu启用状态
func GetHostIommuStatus(params model.GetHostIommuStatusRequest) models.Result[any] {
...
// 更新物理机Iommu启用状态
func UpdateHostIommuState(params model.UpdateHostIommuStateRequest) models.Result[any] {
...
// 获取物理机lommu就绪状态
func GetHostIommuState(params model.GetHostIommuStateRequest) models.Result[any] {
...
// 将PCI设备规格加载到云主机
func AddPciDeviceSpecToVmInstance(params model.AddPciDeviceSpecToVmInstanceRequest) models.Result[any] {
...
// 将PCI设备规格从云主机卸载
func RemovePciDeviceSpecFromVmInstance(params model.RemovePciDeviceSpecFromVmInstanceRequest) models.Result[any] {
...
// 更新PCI设备规格
func UpdatePciDeviceSpec(params model.UpdatePciDeviceSpecRequest) models.Result[any] {
...
// 获取PCI设备规格候选列表
func GetPciDeviceSpecCandidates(params model.GetPciDeviceSpecCandidatesRequest) models.Result[any] {
...
// 查询PCI设备规格
func QueryPciDeviceSpec(params model.QueryPciDeviceSpecRequest) models.Result[any] {
...
// 查询云主机与PCI设备规格的关联关系
func QueryVmInstancePciDeviceSpecRef(params model.QueryVmInstancePciDeviceSpecRefRequest) models.Result[any] {
...
// 虚拟化切分支持SR-IOV的PCI设备
func GenerateSriovPciDevices(params model.GenerateSriovPciDevicesRequest) models.Result[any] {
...
// 虚拟化还原支持SR-IOV的PCI设备
func UngenerateSriovPciDevices(params model.UngenerateSriovPciDevicesRequest) models.Result[any] {
	//PUT zstack/v1/pci-devices/{pciDeviceUuid}/actions
	url := fmt.Sprintf("zstack/v1/pci-devices/%s/actions", params.PciDeviceUuid)
...
func GenerateMdevDevices(params model.GenerateMdevDevicesRequest) models.Result[any] {
	//PUT zstack/v1/pci-devices/{pciDeviceUuid}/actions
	url := fmt.Sprintf("zstack/v1/pci-devices/%s/actions", params.PciDeviceUuid)
...
func UngenerateMdevDevices(params model.UngenerateMdevDevicesRequest) models.Result[any] {
	//PUT zstack/v1/pci-devices/{pciDeviceUuid}/actions
	url := fmt.Sprintf("zstack/v1/pci-devices/%s/actions", params.PciDeviceUuid)
...
// 查询PCI设备切分出的MDEV设备
func QueryMdevDeviceSpec(params model.QueryMdevDeviceSpecRequest) models.Result[any] {
...
func AttachMdevDeviceToVm(params model.AttachMdevDeviceToVmRequest) models.Result[any] {
...
func DetachMdevDeviceFromVm(params model.DetachMdevDeviceFromVmRequest) models.Result[any] {
...
// 更新PCI设备切分出的MDEV设备
func UpdateMdevDevice(params model.UpdateMdevDeviceRequest) models.Result[any] {
...
// 获取可用的MDEV设备
func GetMdevDeviceCandidates(params model.GetMdevDeviceCandidatesRequest) models.Result[any] {
...
// 查询PCI设备切分出的MDEV设备
func QueryMdevDevice(params model.QueryMdevDeviceRequest) models.Result[any] {
...
// 将MDEV设备规格加载到云主机
func AddMdevDeviceSpecToVmInstance(params model.AddMdevDeviceSpecToVmInstanceRequest) models.Result[any] {
...
// 将MDEV设备规格从云主机卸载
func RemoveMdevDeviceSpecFromVmInstance(params model.RemoveMdevDeviceSpecFromVmInstanceRequest) models.Result[any] {
...
// 更新MDEV设备规格
func UpdateMdevDeviceSpec(params model.UpdateMdevDeviceSpecRequest) models.Result[any] {
...
// 获取可用的MDEV设备规格
func GetMdevDeviceSpecCandidates(params model.GetMdevDeviceSpecCandidatesRequest) models.Result[any] {
...
// 查询云主机与MDEV设备规格的关联关系
func QueryVmInstanceMdevDeviceSpecRef(params model.QueryVmInstanceMdevDeviceSpecRefRequest) models.Result[any] {
