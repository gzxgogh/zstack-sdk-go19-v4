...
// 查询SCSI Lun
func QueryScsiLun(vmInstance model.QueryScsiLunRequest) models.Result[any] {
...
// 将LUN设备从物理机卸载
func DetachScsiLunFromHost(vmInstance model.DetachScsiLunFromHostRequest) models.Result[any] {
...
// 添加iSCSI服务器
func AddIscsiServer(vmInstance model.AddIscsiServerRequest) models.Result[any] {
...
// 删除iSCSI服务器
func DeleteIscsiServer(vmInstance model.DeleteIscsiServerRequest) models.Result[any] {
...
// 查询iSCSI服务器
func QueryIscsiServer(vmInstance model.QueryIscsiServerRequest) models.Result[any] {
...
// 刷新iSCSI服务器
func RefreshIscsiServer(vmInstance model.RefreshIscsiServerRequest) models.Result[any] {
...
// 更新iSCSI服务器配置
func UpdateIscsiServer(vmInstance model.UpdateIscsiServerRequest) models.Result[any] {
	//POST zstack/v1/storage-devices/iscsi/servers
	url := fmt.Sprintf("zstack/v1/storage-devices/iscsi/servers")
...
// 将iSCSI服务器加载到集群
func AttachIscsiServerToCluster(vmInstance model.AttachIscsiServerToClusterRequest) models.Result[any] {
...
// 将iSCSI服务器从集群卸载
func DetachIscsiServerFromCluster(vmInstance model.DetachIscsiServerFromClusterRequest) models.Result[any] {
...
// 查询iSCSI磁盘
func QueryIscsiLun(vmInstance model.QueryIscsiLunRequest) models.Result[any] {
...
// 查询FC SAN存储
func QueryFiberChannelStorage(vmInstance model.QueryFiberChannelStorageRequest) models.Result[any] {
...
// 刷新FC SAN存储
func RefreshFiberChannelStorage(vmInstance model.RefreshFiberChannelStorageRequest) models.Result[any] {
...
// 更新SCSI LUN配置
func UpdateScsiLun(vmInstance model.UpdateScsiLunRequest) models.Result[any] {
	//PUT zstack/v1/storage-devices/scsi-lun/{uuid}/actions
...
// 将SCSI LUN加载到云主机
func AttachScsiLunToVmInstance(vmInstance model.AttachScsiLunToVmInstanceRequest) models.Result[any] {
...
// 将SCSI LUN从云主机卸载
func DetachScsiLunFromVmInstance(vmInstance model.DetachScsiLunFromVmInstanceRequest) models.Result[any] {
...
// 检查SCSI Lun与集群连接关系
func CheckScsiLunClusterStatus(vmInstance model.CheckScsiLunClusterStatusRequest) models.Result[any] {
...
// 获取可加载的SCSI Lun
func GetScsiLunCandidatesForAttachingVm(vmInstance model.GetScsiLunCandidatesForAttachingVmRequest) models.Result[any] {
