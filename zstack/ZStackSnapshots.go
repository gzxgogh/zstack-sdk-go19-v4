...
// 创建快照组
func CreateVolumeSnapshotGroup(params model.CreateVolumeSnapshotGroupRequest) models.Result[any] {
...
// 删除快照组
func DeleteVolumeSnapshotGroup(params model.DeleteVolumeSnapshotGroupRequest) models.Result[any] {
...
// 更新快照组信息
func UpdateVolumeSnapshotGroup(params model.UpdateVolumeSnapshotGroupRequest) models.Result[any] {
...
// 查询快照组
func QueryVolumeSnapshotGroup(params model.QueryVolumeSnapshotGroupRequest) models.Result[any] {
...
// 检查快照组可用性
func CheckVolumeSnapshotGroupAvailability(params model.CheckVolumeSnapshotGroupAvailabilityRequest) models.Result[any] {
...
// 恢复快照组
func RevertVmFromSnapshotGroup(params model.RevertVmFromSnapshotGroupRequest) models.Result[any] {
	//PUT zstack/v1/volume-snapshots/group/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/volume-snapshots/group/%s/actions", params.Uuid)
...
// 解绑快照组
func UngroupVolumeSnapshotGroup(params model.UngroupVolumeSnapshotGroupRequest) models.Result[any] {
