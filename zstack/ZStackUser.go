...
// 创建账户
func CreateAccount(params model.CreateAccountRequest) models.Result[any] {
...
// 删除账户
func DeleteAccount(params model.DeleteAccountRequest) models.Result[any] {
...
// 查询账户
func QueryAccount(params model.QueryAccountRequest) models.Result[any] {
...
// 更新账户
func UpdateAccount(params model.UpdateAccountRequest) models.Result[any] {
...
// 使用账户身份登录
func LogInByAccount(params model.LogInByAccountRequest) models.Result[any] {
...
// 获取登录验证码
func GetLoginCaptcha(params model.GetLoginCaptchaRequest) models.Result[any] {
...
// 刷新验证码
func RefreshCaptcha(params model.RefreshCaptchaRequest) models.Result[any] {
...
// 获取双因子认证密匙
func GetTwoFactorAuthenticationSecret(params model.GetTwoFactorAuthenticationSecretRequest) models.Result[any] {
...
// 查询双因子认证密匙
func QueryTwoFactorAuthentication(params model.QueryTwoFactorAuthenticationRequest) models.Result[any] {
...
// 获取双因子认证状态
func GetTwoFactorAuthenticationState(params model.GetTwoFactorAuthenticationStateRequest) models.Result[any] {
...
// 获取账户配额使用情况
func GetAccountQuotaUsage(params model.GetAccountQuotaUsageRequest) models.Result[any] {
...
// 查询账户资源引用
func QueryAccountResourceRef(params model.QueryAccountResourceRefRequest) models.Result[any] {
...
// 共享资源给账户
func ShareResource(params model.ShareResourceRequest) models.Result[any] {
...
// 创建用户组
func CreateUserGroup(params model.CreateUserGroupRequest) models.Result[any] {
...
// 删除用户组
func DeleteUserGroup(params model.DeleteUserGroupRequest) models.Result[any] {
...
// 查询用户组
func QueryUserGroup(params model.QueryUserGroupRequest) models.Result[any] {
...
// 更新用户组
func UpdateUserGroup(params model.UpdateUserGroupRequest) models.Result[any] {
...
// 添加到用户组
func AddUserToGroup(params model.AddUserToGroupRequest) models.Result[any] {
...
// 绑定策略到用户组
func AttachPolicyToUserGroup(params model.AttachPolicyToUserGroupRequest) models.Result[any] {
...
// 将策略从用户组解绑
func DetachPolicyFromUserGroup(params model.DetachPolicyFromUserGroupRequest) models.Result[any] {
...
// 从用户组中移除用户
func RemoveUserFromGroup(params model.RemoveUserFromGroupRequest) models.Result[any] {
...
// 创建用户
func CreateUser(params model.CreateUserRequest) models.Result[any] {
...
// 删除用户
func DeleteUser(params model.DeleteUserRequest) models.Result[any] {
...
// 查询用户
func QueryUser(params model.QueryUserRequest) models.Result[any] {
...
// 更新用户
func UpdateUser(params model.UpdateUserRequest) models.Result[any] {
...
// 使用用户身份登录
func LogInByUser(params model.LogInByUserRequest) models.Result[any] {
...
// 绑定一条策略到用户
func AttachPolicyToUser(params model.AttachPolicyToUserRequest) models.Result[any] {
...
// 将一条策略从用户解绑
func DetachPolicyFromUser(params model.DetachPolicyFromUserRequest) models.Result[any] {
	//DELETE zstack/v1/accounts/groups/{groupUuid}/policies/{policyUuid}
	url := fmt.Sprintf("zstack/v1/accounts/groups/%s/policies/%s", params.GroupUuid, params.PolicyUuid)
...
// 绑定多条策略到用户
func AttachPoliciesToUser(params model.AttachPoliciesToUserRequest) models.Result[any] {
...
// 将多条策略从用户解绑
func DetachPoliciesFromUser(params model.DetachPoliciesFromUserRequest) models.Result[any] {
...
// 查询配额
func QueryQuota(params model.QueryQuotaRequest) models.Result[any] {
...
// 更新配额
func UpdateQuota(params model.UpdateQuotaRequest) models.Result[any] {
...
// 获取资源名称
func GetResourceNames(params model.GetResourceNamesRequest) models.Result[any] {
...
// 查询共享资源
func QuerySharedResource(params model.QuerySharedResourceRequest) models.Result[any] {
...
// 解除资源共享
func RevokeResourceSharingRequest(params model.RevokeResourceSharingRequest) models.Result[any] {
	//PUT zstack/v1/accounts/resources/actions
	url := fmt.Sprintf("zstack/v1/accounts/resources/actions")
...
// 变更资源所有者
func ChangeResourceOwner(params model.ChangeResourceOwnerRequest) models.Result[any] {
...
// 检查API权限
func CheckApiPermission(params model.CheckApiPermissionRequest) models.Result[any] {
...
// 验证会话的有效性
func ValidateSession(params model.ValidateSessionRequest) models.Result[any] {
...
// 更新会话
func RenewSession(params model.RenewSessionRequest) models.Result[any] {
...
// 退出当前登录状态
func LogOut(params model.LogOutRequest) models.Result[any] {
