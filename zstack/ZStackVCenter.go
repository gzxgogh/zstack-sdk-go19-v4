...
// 添加vCenter资源
func AddVCenter(params model.AddVCenterRequest) models.Result[any] {
...
// 查询vCenter资源
func QueryVCenter(params model.QueryVCenterRequest) models.Result[any] {
...
// 删除vCenter资源
func DeleteVCenter(params model.DeleteVCenterRequest) models.Result[any] {
...
// 更新vCenter资源
func UpdateVCenter(params model.UpdateVCenterRequest) models.Result[any] {
...
// 同步vCenter资源
func SyncVCenter(params model.SyncVCenterRequest) models.Result[any] {
	//PUT zstack/v1/vcenters/{uuid}/actions
	url := fmt.Sprintf("PUT zstack/v1/vcenters/%s/actions", params.UUID)
...
// 查询vCenter集群
func QueryVCenterCluster(params model.QueryVCenterClusterRequest) models.Result[any] {
...
// 查询vCenter主存储
func QueryVCenterPrimaryStorage(params model.QueryVCenterPrimaryStorageRequest) models.Result[any] {
...
// 查询vCenter镜像服务器
func QueryVCenterBackupStorage(params model.QueryVCenterBackupStorageRequest) models.Result[any] {
...
// 查询vCenter资源池
func QueryVCenterResourcePool(params model.QueryVCenterResourcePoolRequest) models.Result[any] {
