...
// 创建VPC路由器
func CreateVpcVRouter(params model.CreateVpcVRouterRequest) models.Result[any] {
...
// 查询VPC路由器
func QueryVpcRouter(params model.QueryVpcRouterRequest) models.Result[any] {
...
// 获取VPC路由器可加载的三层网络
func GetAttachableVpcL3Network(params model.GetAttachableVpcL3NetworkRequest) models.Result[any] {
...
// 获取实时流量状态
func GetVpcVRouterDistributedRoutingConnections(params model.GetVpcVRouterDistributedRoutingConnectionsRequest) models.Result[any] {
...
// 获取分布式路由是否打开
func GetVpcVRouterDistributedRoutingEnabled(params model.GetVpcVRouterDistributedRoutingEnabledRequest) models.Result[any] {
...
// 设置分布式路由开关
func SetVpcVRouterDistributedRoutingEnabled(params model.SetVpcVRouterDistributedRoutingEnabledRequest) models.Result[any] {
...
// 向VPC路由器添加DNS
func AddDnsToVpcRouter(params model.AddDnsToVpcRouterRequest) models.Result[any] {
...
// 从VPC路由器移除DNS
func RemoveDnsFromVpcRouter(params model.RemoveDnsFromVpcRouterRequest) models.Result[any] {
...
// 获取VPC路由器的网络服务状态
func GetVpcVRouterNetworkServiceState(params model.GetVpcVRouterNetworkServiceStateRequest) models.Result[any] {
...
// 设置VPC路由器的网络服务
func SetVpcVRouterNetworkServiceState(params model.SetVpcVRouterNetworkServiceStateRequest) models.Result[any] {
...
// 更新高可用组仲裁ip
func ChangeVpcHaGroupMonitorIps(params model.ChangeVpcHaGroupMonitorIpsRequest) models.Result[any] {
...
// 创建高可用组
func CreateVpcHaGroup(params model.CreateVpcHaGroupRequest) models.Result[any] {
...
// 删除高可用组
func DeleteVpcHaGroup(params model.DeleteVpcHaGroupRequest) models.Result[any] {
...
// 更新高可用组
func UpdateVpcHaGroup(params model.UpdateVpcHaGroupRequest) models.Result[any] {
...
// 查询高可用
func QueryVpcHaGroup(params model.QueryVpcHaGroupRequest) models.Result[any] {
...
// 更新虚拟路由器
func UpdateVirtualRouter(params model.UpdateVirtualRouterRequest) models.Result[any] {
