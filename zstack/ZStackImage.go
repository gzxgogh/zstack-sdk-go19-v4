...
// 添加镜像
func AddImage(params model.AddImageRequest) models.Result[any] {
...
// 彻底删除镜像
func ExpungeImage(params model.ExpungeImageRequest) models.Result[any] {
...
// 恢复镜像
func RecoverImage(params model.RecoverImageRequest) models.Result[any] {
	//PUT zstack/v1/images/{imageUuid}/actions
	url := fmt.Sprintf("zstack/v1/images/%s/actions", params.ImageUuid)
...
// 修改镜像状态
func ChangeImageState(params model.ChangeImageStateRequest) models.Result[any] {
...
// 刷新镜像大小信息
func SyncImageSize(params model.SyncImageSizeRequest) models.Result[any] {
	//PUT zstack/v1/images/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/images/%s/actions", params.Uuid)
...
// 获取镜像服务器候选
func GetCandidateBackupStorageForCreatingImage(params model.GetCandidateBackupStorageForCreatingImageRequest) models.Result[any] {
	url := ""
...
// 从根云盘创建根云盘镜像
func CreateRootVolumeTemplateFromRootVolume(params model.CreateRootVolumeTemplateFromRootVolumeRequest) models.Result[any] {
...
// 从云盘快照创建根云盘镜像
func CreateRootVolumeTemplateFromVolumeSnapshot(params model.CreateRootVolumeTemplateFromVolumeSnapshotRequest) models.Result[any] {
...
// 从云盘创建数据云盘镜像
func CreateDataVolumeTemplateFromVolume(params model.CreateDataVolumeTemplateFromVolumeRequest) models.Result[any] {
...
// 从云盘快照创建数据云盘镜像
func CreateDataVolumeTemplateFromVolumeSnapshot(params model.CreateDataVolumeTemplateFromVolumeSnapshotRequest) models.Result[any] {
...
// 获取镜像Qga
func GetImageQga(params model.GetImageQgaRequest) models.Result[any] {
...
// 设置镜像Qga
func SetImageQga(params model.SetImageQgaRequest) models.Result[any] {
	//PUT zstack/v1/images/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/images/%s/actions", params.Uuid)
...
// 设置镜像启动模式
func SetImageBootMode(params model.SetImageBootModeRequest) models.Result[any] {
	//PUT zstack/v1/images/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/images/%s/actions", params.Uuid)
...
// 获取上传镜像任务详情
func GetUploadImageJobDetails(params model.GetUploadImageJobDetailsRequest) models.Result[any] {
