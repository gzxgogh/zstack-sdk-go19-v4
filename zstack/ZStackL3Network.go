...
// 创建三层网络
func CreateL3Network(params model.CreateL3NetworkRequest) models.Result[any] {
...
// 删除三层网络
func DeleteL3Network(params model.DeleteL3NetworkRequest) models.Result[any] {
...
// 查询三层网络
func QueryL3Network(params model.QueryL3NetworkRequest) models.Result[any] {
...
// 更新三层网络
func UpdateL3Network(params model.UpdateL3NetworkRequest) models.Result[any] {
...
// 获取三层网络类型
func GetL3NetworkTypes(params model.GetL3NetworkTypesRequest) models.Result[any] {
...
// 改变三层网络状态
func ChangeL3NetworkState(params model.ChangeL3NetworkStateRequest) models.Result[any] {
	//PUT zstack/v1/l3-networks/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/l3-networks/%s/actions", params.UUID)
...
// 获取网络DHCP服务所用地址
func GetL3NetworkDhcpIpAddress(params model.GetL3NetworkDhcpIpAddressRequest) models.Result[any] {
...
// 向三层网络添加DNS
func AddDnsToL3Network(params model.AddDnsToL3NetworkRequest) models.Result[any] {
...
// 从三层网络移除DNS
func RemoveDnsFromL3Network(params model.RemoveDnsFromL3NetworkRequest) models.Result[any] {
...
// 向三层网络添加主机路由
func AddHostRouteToL3Network(params model.AddHostRouteToL3NetworkRequest) models.Result[any] {
...
// 从三层网络移除主机路由
func RemoveHostRouteFromL3Network(params model.RemoveHostRouteFromL3NetworkRequest) models.Result[any] {
...
// 获取空闲IP
func GetFreeIp(params model.GetFreeIpRequest) models.Result[any] {
...
// 检查IP可用性
func CheckIpAvailability(params model.CheckIpAvailabilityRequest) models.Result[any] {
...
// 获取IP网络地址容量
func GetIpAddressCapacity(params model.GetIpAddressCapacityRequest) models.Result[any] {
...
// 添加IP地址范围
func AddIpRange(params model.AddIpRangeRequest) models.Result[any] {
...
// 删除IP地址范围
func DeleteIpRange(params model.DeleteIpRangeRequest) models.Result[any] {
...
// 查询IP地址范围
func QueryIpRange(params model.QueryIpRangeRequest) models.Result[any] {
...
// 更新IP地址范围
func UpdateIpRange(params model.UpdateIpRangeRequest) models.Result[any] {
...
// 通过网络CIDR添加IP地址范围
func AddIpRangeByNetworkCidr(params model.AddIpRangeByNetworkCidrRequest) models.Result[any] {
...
// 获取三层网络Mtu值
func GetL3NetworkMtu(params model.GetL3NetworkMtuRequest) models.Result[any] {
...
// 设置三层网络Mtu值
func SetL3NetworkMtu(params model.SetL3NetworkMtuRequest) models.Result[any] {
...
// 获取三层网络上路由器的接口地址
func GetL3NetworkRouterInterfaceIp(params model.GetL3NetworkRouterInterfaceIpRequest) models.Result[any] {
...
// 设置三层网络路由器接口IP
func SetL3NetworkRouterInterfaceIp(params model.SetL3NetworkRouterInterfaceIpRequest) models.Result[any] {
...
// 添加IPv6地址范围
func AddIpv6Range(params model.AddIpv6RangeRequest) models.Result[any] {
...
// 通过网络CIDR添加IPv6地址范围
func AddIpv6RangeByNetworkCidr(params model.AddIpv6RangeByNetworkCidrRequest) models.Result[any] {
...
// 查询IP地址
func QueryIpAddress(params model.QueryIpAddressRequest) models.Result[any] {
...
// 获取三层网络IP地址使用情况统计
func GetL3NetworkIpStatistic(params model.GetL3NetworkIpStatisticRequest) models.Result[any] {
...
// 查询IP地址池
func QueryAddressPool(params model.QueryAddressPoolRequest) models.Result[any] {
