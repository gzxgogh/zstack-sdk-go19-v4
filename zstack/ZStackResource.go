...
// 添加资源栈模板
func AddStackTemplate(params model.AddStackTemplateRequest) models.Result[any] {
...
// 删除资源栈模板
func DeleteStackTemplate(params model.DeleteStackTemplateRequest) models.Result[any] {
...
// 查询资源栈模板
func QueryStackTemplate(params model.QueryStackTemplateRequest) models.Result[any] {
...
// 修改资源栈模板
func UpdateStackTemplate(params model.UpdateStackTemplateRequest) models.Result[any] {
...
// 获取支持的资源列表
func GetSupportedCloudFormationResources(params model.GetSupportedCloudFormationResourcesRequest) models.Result[any] {
...
// 创建资源栈
func CreateResourceStack(params model.CreateResourceStackRequest) models.Result[any] {
...
// 预览资源栈
func PreviewResourceStack(params model.PreviewResourceStackRequest) models.Result[any] {
...
// 删除资源栈
func DeleteResourceStack(params model.DeleteResourceStackRequest) models.Result[any] {
...
// 修改资源栈
func UpdateResourceStack(params model.UpdateResourceStackRequest) models.Result[any] {
...
// 查询资源栈
func QueryResourceStack(params model.QueryResourceStackRequest) models.Result[any] {
...
// 获取资源栈内资源列表
func GetResourceFromResourceStack(params model.GetResourceFromResourceStackRequest) models.Result[any] {
...
// 查询资源栈内事件列表
func QueryEventFromResourceStack(params model.QueryEventFromResourceStackRequest) models.Result[any] {
...
// 重启资源栈
func RestartResourceStackRequestStack(params model.RestartResourceStackRequest) models.Result[any] {
	//PUT zstack/v1/cloudformation/stack/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/cloudformation/stack/%s/actions", params.UUID)
...
// 检查资源栈模板参数
func CheckStackTemplateParameters(params model.CheckStackTemplateParametersRequest) models.Result[any] {
...
// 从资源编排模板解析成资源关系图
func DecodeStackTemplate(params model.DecodeStackTemplateRequest) models.Result[any] {
...
// 获取资源对应的资源栈
func GetResourceStackFromResource(params model.GetResourceStackFromResourceRequest) models.Result[any] {
...
// 获取资源栈中云主机端口监控状态
func GetResourceStackVmStatus(params model.GetResourceStackVmStatusRequest) models.Result[any] {
...
// 添加资源栈中云主机端口监控
func AddResourceStackVmPortMonitor(params model.AddResourceStackVmPortMonitorRequest) models.Result[any] {
...
// 删除资源栈中云主机端口监控
func DeleteResourceStackVmPortMonitor(params model.DeleteResourceStackVmPortMonitorRequest) models.Result[any] {
