...
// 创建防火墙
func CreateVpcFirewall(params model.CreateVpcFirewallRequest) models.Result[any] {
...
// 查询防火墙
func QueryVpcFirewall(params model.QueryVpcFirewallRequest) models.Result[any] {
...
// 更新防火墙
func UpdateVpcFirewall(params model.UpdateVpcFirewallRequest) models.Result[any] {
...
// 刷新防火墙配置
func RefreshFirewall(params model.RefreshFirewallRequest) models.Result[any] {
...
// 删除防火墙
func DeleteFirewall(params model.DeleteFirewallRequest) models.Result[any] {
...
// 创建防火墙规则集
func CreateFirewallRuleSet(params model.CreateFirewallRuleSetRequest) models.Result[any] {
...
// 查询防火墙规则集
func QueryFirewallRuleSet(params model.QueryFirewallRuleSetRequest) models.Result[any] {
...
// 更新防火墙规则集
func UpdateFirewallRuleSet(params model.UpdateFirewallRuleSetRequest) models.Result[any] {
...
// 删除防火墙规则集
func DeleteFirewallRuleSet(params model.DeleteFirewallRuleSetRequest) models.Result[any] {
...
// 网络加载防火墙规则集
func AttachFirewallRuleSetToL3(params model.AttachFirewallRuleSetToL3Request) models.Result[any] {
...
// 网络卸载防火墙规则集
func DetachFirewallRuleSetFromL3(params model.DetachFirewallRuleSetFromL3Request) models.Result[any] {
...
// 查询防火墙规则集与三层网络关联关系
func QueryFirewallRuleSetL3Ref(params model.QueryFirewallRuleSetL3RefRequest) models.Result[any] {
...
// 创建防火墙规则
func CreateFirewallRule(params model.CreateFirewallRuleRequest) models.Result[any] {
...
// 查询防火墙规则
func QueryFirewallRule(params model.QueryFirewallRuleRequest) models.Result[any] {
...
// 更新防火墙规则
func UpdateFirewallRule(params model.UpdateFirewallRuleRequest) models.Result[any] {
...
// 删除防火墙规则
func DeleteFirewallRule(params model.DeleteFirewallRuleRequest) models.Result[any] {
...
// 更改防火墙规则状态
func ChangeFirewallRuleState(params model.ChangeFirewallRuleStateRequest) models.Result[any] {
	//PUT zstack/v1/vpcfirewalls/rules/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/vpcfirewalls/rules/%s/actions", params.UUID)
...
// 创建防火墙规则模板
func CreateFirewallRuleTemplate(params model.CreateFirewallRuleTemplateRequest) models.Result[any] {
...
// 删除防火墙规则模板
func DeleteFirewallRuleTemplate(params model.DeleteFirewallRuleTemplateRequest) models.Result[any] {
...
// 更新防火墙规则模板
func UpdateFirewallRuleTemplate(params model.UpdateFirewallRuleTemplateRequest) models.Result[any] {
...
// 查询防火墙规则模板
func QueryFirewallRuleTemplate(params model.QueryFirewallRuleTemplateRequest) models.Result[any] {
...
// 查询防火墙与单节点路由器关联关系
func QueryVpcFirewallVRouterRef(params model.QueryVpcFirewallVRouterRefRequest) models.Result[any] {
...
// 下发规则集更改内容到路由器
func ApplyRuleSetChanges(params model.ApplyRuleSetChangesRequest) models.Result[any] {
...
// 创建防火墙IP或端口模板
func CreateFirewallIpSetTemplate(params model.CreateFirewallIpSetTemplateRequest) models.Result[any] {
...
// 删除防火墙IP或端口模板
func DeleteFirewallIpSetTemplate(params model.DeleteFirewallIpSetTemplateRequest) models.Result[any] {
...
// 更新防火墙IP或端口模板
func UpdateFirewallIpSetTemplate(params model.UpdateFirewallIpSetTemplateRequest) models.Result[any] {
...
// 查询防火墙IP或端口模板
func QueryFirewallIpSetTemplate(params model.QueryFirewallIpSetTemplateRequest) models.Result[any] {
