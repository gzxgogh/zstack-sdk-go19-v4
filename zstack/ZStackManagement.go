...
// 请求控制台访问地址
func RequestConsoleAccess(params model.RequestConsoleAccessRequest) models.Result[any] {
...
// 查询控制台代理
func QueryConsoleProxyAgent(params model.QueryConsoleProxyAgentRequest) models.Result[any] {
...
// 重连控制台代理
func ReconnectConsoleProxyAgent(params model.ReconnectConsoleProxyAgentRequest) models.Result[any] {
...
// 更新控制台代理
func UpdateConsoleProxyAgent(params model.UpdateConsoleProxyAgentRequest) models.Result[any] {
...
// 增加IP访问控制规则
func AddAccessControlRule(params model.AddAccessControlRuleRequest) models.Result[any] {
...
// 删除IP访问控制规则
func DeleteAccessControlRule(params model.DeleteAccessControlRuleRequest) models.Result[any] {
...
// 更新IP访问控制规则
func UpdateAccessControlRule(params model.UpdateAccessControlRuleRequest) models.Result[any] {
...
// 查询IP访问控制规则
func QueryAccessControlRule(params model.QueryAccessControlRuleRequest) models.Result[any] {
...
// 创建AccessKey
func CreateAccessKey(params model.CreateAccessKeyRequest) models.Result[any] {
...
// 删除AccessKey
func DeleteAccessKey(params model.DeleteAccessKeyRequest) models.Result[any] {
...
// 查询AccessKey
func QueryAccessKey(params model.QueryAccessKeyRequest) models.Result[any] {
...
// 开启或关闭AccessKey
func ChangeAccessKeyState(params model.ChangeAccessKeyStateRequest) models.Result[any] {
...
// 添加日志服务器配置
func AddLogConfiguration(params model.AddLogConfigurationRequest) models.Result[any] {
...
// 删除日志服务器配置
func DeleteLogConfiguration(params model.DeleteLogConfigurationRequest) models.Result[any] {
...
// 获取日志服务器配置
func GetLogConfiguration(params model.GetLogConfigurationRequest) models.Result[any] {
...
// 修改日志服务器配置
func UpdateLogConfiguration(params model.UpdateLogConfigurationRequest) models.Result[any] {
