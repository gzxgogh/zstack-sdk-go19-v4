...
// 创建负载均衡器
func CreateLoadBalancer(params model.CreateLoadBalancerRequest) models.Result[any] {
...
// 删除负载均衡器
func DeleteLoadBalancer(params model.DeleteLoadBalancerRequest) models.Result[any] {
...
// 查询负载均衡器
func QueryLoadBalancer(params model.QueryLoadBalancerRequest) models.Result[any] {
...
// 刷新负载均衡器
func RefreshLoadBalancer(params model.RefreshLoadBalancerRequest) models.Result[any] {
...
// 创建负载均衡监听器
func CreateLoadBalancerListener(params model.CreateLoadBalancerListenerRequest) models.Result[any] {
...
// 删除负载均衡监听器
func DeleteLoadBalancerListener(params model.DeleteLoadBalancerListenerRequest) models.Result[any] {
...
// 查询负载均衡监听器
func QueryLoadBalancerListener(params model.QueryLoadBalancerListenerRequest) models.Result[any] {
...
// 更新负载均衡监听器
func UpdateLoadBalancerListener(params model.UpdateLoadBalancerListenerRequest) models.Result[any] {
...
// 修改负载均衡监听器参数
func ChangeLoadBalancerListener(params model.ChangeLoadBalancerListenerRequest) models.Result[any] {
...
// 获取云主机网卡
func GetCandidateVmNicsForLoadBalancer(params model.GetCandidateVmNicsForLoadBalancerRequest) models.Result[any] {
...
// 添加云主机网卡到负载均衡器
func AddVmNicToLoadBalancer(params model.AddVmNicToLoadBalancerRequest) models.Result[any] {
...
// 从负载均衡器移除云主机网卡
func RemoveVmNicFromLoadBalancer(params model.RemoveVmNicFromLoadBalancerRequest) models.Result[any] {
...
// 更新负载均衡器
func UpdateLoadBalancer(params model.UpdateLoadBalancerRequest) models.Result[any] {
	//PUT zstack/v1/load-balancers/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/load-balancers/%s/actions", params.UUID)
...
// 添加证书到负载均衡
func AddCertificateToLoadBalancerListener(params model.AddCertificateToLoadBalancerListenerRequest) models.Result[any] {
...
// 从负载均衡移除证书
func RemoveCertificateFromLoadBalancerListener(params model.RemoveCertificateFromLoadBalancerListenerRequest) models.Result[any] {
...
// 添加转发规则到访问控制策略组
func AddAccessControlListRedirectRule(params model.AddAccessControlListRedirectRuleRequest) models.Result[any] {
...
// 修改控制策略组转发规则名称
func ChangeAccessControlListRedirectRule(params model.ChangeAccessControlListRedirectRuleRequest) models.Result[any] {
...
// 修改访问控制组绑定的后端服务器组
func ChangeAccessControlListServerGroup(params model.ChangeAccessControlListServerGroupRequest) models.Result[any] {
...
// 获取负载均衡监听器访问控制策略条目
func GetLoadBalancerListenerACLEntries(params model.GetLoadBalancerListenerACLEntriesRequest) models.Result[any] {
...
// 创建访问控制策略组
func CreateAccessControlList(params model.CreateAccessControlListRequest) models.Result[any] {
...
// 删除访问控制策略组
func DeleteAccessControlList(params model.DeleteAccessControlListRequest) models.Result[any] {
...
// 查询访问控制策略组
func QueryAccessControlList(params model.QueryAccessControlListRequest) models.Result[any] {
...
// 向访问控制策略组添加IP组
func AddAccessControlListEntry(params model.AddAccessControlListEntryRequest) models.Result[any] {
...
// 删除访问控制策略的IP组
func RemoveAccessControlListEntry(params model.RemoveAccessControlListEntryRequest) models.Result[any] {
...
// 添加监听器的访问控制策略
func AddAccessControlListToLoadBalancer(params model.AddAccessControlListToLoadBalancerRequest) models.Result[any] {
...
// 删除监听器访问控制策略
func RemoveAccessControlListFromLoadBalancer(params model.RemoveAccessControlListFromLoadBalancerRequest) models.Result[any] {
...
// 获取监听器可加载L3网络
func GetCandidateL3NetworksForLoadBalancer(params model.GetCandidateL3NetworksForLoadBalancerRequest) models.Result[any] {
...
// 创建负载均衡器服务器组
func CreateLoadBalancerServerGroup(params model.CreateLoadBalancerServerGroupRequest) models.Result[any] {
...
// 删除负载均衡器服务器组
func DeleteLoadBalancerServerGroup(params model.DeleteLoadBalancerServerGroupRequest) models.Result[any] {
...
// 更新负载均衡器服务器组
func UpdateLoadBalancerServerGroup(params model.UpdateLoadBalancerServerGroupRequest) models.Result[any] {
...
// 查询负载均衡器服务器组
func QueryLoadBalancerServerGroup(params model.QueryLoadBalancerServerGroupRequest) models.Result[any] {
...
// 添加后端服务器到服务器组
func AddBackendServerToServerGroup(params model.AddBackendServerToServerGroupRequest) models.Result[any] {
...
// 从服务器组移除后端服务器
func RemoveBackendServerFromServerGroup(params model.RemoveBackendServerFromServerGroupRequest) models.Result[any] {
...
// 添加服务器组到负载均衡监听器
func AddServerGroupToLoadBalancerListener(params model.AddServerGroupToLoadBalancerListenerRequest) models.Result[any] {
...
// 从负载均衡监听器移除服务器组
func RemoveServerGroupFromLoadBalancerListener(params model.RemoveServerGroupFromLoadBalancerListenerRequest) models.Result[any] {
...
// 更新负载均衡后端服务器参数
func ChangeLoadBalancerBackendServer(params model.ChangeLoadBalancerBackendServerRequest) models.Result[any] {
...
func GetCandidateVmNicsForLoadBalancerServerGroup(params model.GetCandidateVmNicsForLoadBalancerServerGroupRequest) models.Result[any] {
...
// 创建性能独享型负载均衡器组
func CreateSlbGroup(params model.CreateSlbGroupRequest) models.Result[any] {
...
// 删除性能独享型负载均衡器组
func DeleteSlbGroup(params model.DeleteSlbGroupRequest) models.Result[any] {
...
// 更新性能独享型负载均衡器组
func UpdateSlbGroup(params model.UpdateSlbGroupRequest) models.Result[any] {
...
// 查询性能独享型负载均衡器组
func QuerySlbGroup(params model.QuerySlbGroupRequest) models.Result[any] {
...
// 创建高性能实例性负载均衡器规格
func CreateSlbOffering(params model.CreateSlbOfferingRequest) models.Result[any] {
...
// 查询性能独享型负载均衡器规格
func QuerySlbOffering(params model.QuerySlbOfferingRequest) models.Result[any] {
...
// 创建高性能负载均衡器实例
func CreateSlbInstance(params model.CreateSlbInstanceRequest) models.Result[any] {
