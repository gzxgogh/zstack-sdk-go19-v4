...
// 删除镜像服务器
func DeleteBackupStorage(params model.DeleteBackupStorageRequest) models.Result[any] {
...
// 查询镜像服务器
func QueryBackupStorage(params model.QueryBackupStorageRequest) models.Result[any] {
...
// 重连镜像服务器
func ReconnectBackupStorage(params model.ReconnectBackupStorageRequest) models.Result[any] {
...
// 更改镜像服务器可用状态
func ChangeBackupStorageState(params model.ChangeBackupStorageStateRequest) models.Result[any] {
	//PUT zstack/v1/backup-storage/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/backup-storage/%s/actions", params.UUID)
...
// 获取镜像服务器存储容量
func GetBackupStorageCapacity(params model.GetBackupStorageCapacityRequest) models.Result[any] {
...
// 获取镜像服务器类型列表
func GetBackupStorageTypes(params model.GetBackupStorageTypesRequest) models.Result[any] {
...
// 更新镜像服务器信息
func UpdateBackupStorage(params model.UpdateBackupStorageRequest) models.Result[any] {
	//PUT zstack/v1/backup-storage/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/backup-storage/%s/actions", params.UUID)
...
// 从镜像服务器导出镜像
func ExportImageFromBackupStorage(params model.ExportImageFromBackupStorageRequest) models.Result[any] {
...
// 从镜像服务器删除导出的镜像
func DeleteExportedImageFromBackupStorage(params model.DeleteExportedImageFromBackupStorageRequest) models.Result[any] {
...
// 挂载镜像服务器至区域
func AttachBackupStorageToZone(params model.AttachBackupStorageToZoneRequest) models.Result[any] {
...
// 从区域中卸载已经挂载的镜像服务器
func DetachBackupStorageFromZone(params model.DetachBackupStorageFromZoneRequest) models.Result[any] {
...
// 跨镜像服务器迁移镜像
func BackupStorageMigrateImage(params model.BackupStorageMigrateImageRequest) models.Result[any] {
...
// 获取候选列表
func GetBackupStorageCandidatesForImageMigration(params model.GetBackupStorageCandidatesForImageMigrationRequest) models.Result[any] {
...
// 添加镜像仓库服务器
func AddImageStoreBackupStorage(params model.AddImageStoreBackupStorageRequest) models.Result[any] {
...
// 查询镜像仓库服务器
func QueryImageStoreBackupStorage(params model.QueryImageStoreBackupStorageRequest) models.Result[any] {
...
// 重连镜像仓库服务器
func ReconnectImageStoreBackupStorage(params model.ReconnectImageStoreBackupStorageRequest) models.Result[any] {
...
// 更新镜像仓库服务器信息
func UpdateImageStoreBackupStorage(params model.UpdateImageStoreBackupStorageRequest) models.Result[any] {
	//PUT zstack/v1/backup-storage/image-store/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/backup-storage/image-store/%s/actions", params.UUID)
...
// 从镜像仓库回收磁盘空间
func ReclaimSpaceFromImageStore(params model.ReclaimSpaceFromImageStoreRequest) models.Result[any] {
	//PUT zstack/v1/backup-storage/image-store/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/backup-storage/image-store/%s/actions", params.UUID)
...
// 添加Ceph镜像服务器
func AddCephBackupStorage(params model.AddCephBackupStorageRequest) models.Result[any] {
...
// 查询Ceph镜像服务器
func QueryCephBackupStorage(params model.QueryCephBackupStorageRequest) models.Result[any] {
...
// 更新Ceph镜像服务器mon节点
func UpdateCephBackupStorageMon(params model.UpdateCephBackupStorageMonRequest) models.Result[any] {
...
// Ceph镜像服务器添加mon节点
func AddMonToCephBackupStorage(params model.AddMonToCephBackupStorageRequest) models.Result[any] {
...
// Ceph镜像服务器删除mon节点
func RemoveMonFromCephBackupStorage(params model.RemoveMonFromCephBackupStorageRequest) models.Result[any] {
