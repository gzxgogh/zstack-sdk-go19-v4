...
// 查询物理机
func QueryHost(params model.QueryHostRequest) models.Result[any] {
	//GET zstack/v1/hosts
...
// 删除物理机
func DeleteHost(params model.DeleteHostRequest) models.Result[any] {
...
// 更新物理机信息
func UpdateHost(params model.UpdateHostRequest) models.Result[any] {
...
// 更新物理机启用状态
func ChangeHostState(params model.ChangeHostStateRequest) models.Result[any] {
	//PUT zstack/v1/hosts/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/hosts/%s/actions", params.UUID)
...
// 重连物理机
func ReconnectHost(params model.ReconnectHostRequest) models.Result[any] {
	//PUT zstack/v1/hosts/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/hosts/%s/actions", params.UUID)
...
// 获取物理机分配策略
func GetHostAllocatorStrategies(params model.GetHostAllocatorStrategiesRequest) models.Result[any] {
...
// 获取云主机虚拟化技术类型
func GetHypervisorTypes(params model.GetHypervisorTypesRequest) models.Result[any] {
...
// 更新KVM主机信息
func UpdateKVMHost(params model.UpdateKVMHostRequest) models.Result[any] {
...
// 添加KVM主机
func AddKVMHost(params model.AddKVMHostRequest) models.Result[any] {
...
// KVM运行Shell命令
func KvmRunShell(params model.KvmRunShellRequest) models.Result[any] {
...
// 通过文件导入方式添加物理机
func AddKVMHostFromConfigFile(params model.AddKVMHostFromConfigFileRequest) models.Result[any] {
...
// 添加物理机文件语法检查
func CheckKVMHostConfigFile(params model.CheckKVMHostConfigFileRequest) models.Result[any] {
...
// 获取物理机物理网络信息
func GetHostNetworkFacts(params model.GetHostNetworkFactsRequest) models.Result[any] {
...
// 查询物理机Bond信息
func QueryHostNetworkBonding(params model.QueryHostNetworkBondingRequest) models.Result[any] {
...
// 查询物理机网卡信息
func QueryHostNetworkInterface(params model.QueryHostNetworkInterfaceRequest) models.Result[any] {
...
// 查询物理机的NUMA拓扑信息
func GetHostNUMATopology(params model.GetHostNUMATopologyRequest) models.Result[any] {
...
// 根据云主机需求获取物理机资源的分配信息
func GetHostResourceAllocation(params model.GetHostResourceAllocationRequest) models.Result[any] {
	//GET zstack/v1/hosts/nics
	//GET zstack/v1/hosts/nics/{uuid}
	var url string
	if params.Uuid == "" {
