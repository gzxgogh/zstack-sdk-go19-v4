...
// 创建虚拟IP
func CreateVip(params model.CreateVipRequest) models.Result[any] {
	//POST zstack/v1/vips
...
// 删除虚拟IP
func DeleteVip(params model.DeleteVipRequest) models.Result[any] {
...
// 更新虚拟IP
func UpdateVip(params model.UpdateVipRequest) models.Result[any] {
...
// 更改虚拟IP启用状态
func ChangeVipState(params model.ChangeVipStateRequest) models.Result[any] {
	//PUT zstack/v1/vips/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/vips/%s/actions", params.UUID)
...
// 获取虚拟IP所有业务端口列表
func GetVipUsedPorts(params model.GetVipUsedPortsRequest) models.Result[any] {
...
// 设置虚拟IP限速
func SetVipQos(params model.SetVipQosRequest) models.Result[any] {
	//PUT zstack/v1/vips/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/vips/%s/actions", params.UUID)
...
// 获取虚拟IP限速
func GetVipQos(params model.GetVipQosRequest) models.Result[any] {
...
// 取消虚拟IP限速
func DeleteVipQos(params model.DeleteVipQosRequest) models.Result[any] {
