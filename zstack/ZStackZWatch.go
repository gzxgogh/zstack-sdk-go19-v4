...
// 获取所有metric元数据
func GetAllMetricMetadata(params model.GetAllMetricMetadataRequest) models.Result[any] {
...
// 获取metric的标签值
func GetMetricLabelValue(params model.GetMetricLabelValueRequest) models.Result[any] {
...
// 获取metric数据
func GetMetricData(params model.GetMetricDataRequest) models.Result[any] {
...
// 存入自定义metric数据
func PutMetricData(params model.PutMetricDataRequest) models.Result[any] {
...
// 获取所有event元数据
func GetAllEventMetadata(params model.GetAllEventMetadataRequest) models.Result[any] {
...
// 获取事件
func GetEventData(params model.GetEventDataRequest) models.Result[any] {
...
// 更新事件
func UpdateEventData(params model.UpdateEventDataRequest) models.Result[any] {
...
// 查询事件报警器报警记录
func QueryEventRecord(params model.QueryEventRecordRequest) models.Result[any] {
...
// 创建报警器
func CreateAlarm(params model.CreateAlarmRequest) models.Result[any] {
...
// 删除报警器
func DeleteAlarm(params model.DeleteAlarmRequest) models.Result[any] {
...
// 修改报警器
func UpdateAlarm(params model.UpdateAlarmRequest) models.Result[any] {
...
// 修改事件报警器
func UpdateSubscribeEvent(params model.UpdateSubscribeEventRequest) models.Result[any] {
...
// 增加报警动作
func AddActionToAlarm(params model.AddActionToAlarmRequest) models.Result[any] {
...
// 删除报警动作
func RemoveActionFromAlarm(params model.RemoveActionFromAlarmRequest) models.Result[any] {
...
// 增加标签到报警器
func AddLabelToAlarm(params model.AddLabelToAlarmRequest) models.Result[any] {
...
// 修改报警器标签
func UpdateAlarmLabel(params model.UpdateAlarmLabelRequest) models.Result[any] {
...
// 从报警器上删除标签
func RemoveLabelFromAlarm(params model.RemoveLabelFromAlarmRequest) models.Result[any] {
...
// 更改报警器状态
func ChangeAlarmState(params model.ChangeAlarmStateRequest) models.Result[any] {
	//PUT zstack/v1/zwatch/alarms/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/zwatch/alarms/%s/actions", params.UUID)
...
// 查询报警器
func QueryAlarm(params model.QueryAlarmRequest) models.Result[any] {
...
// 获取报警器历史
func GetAlarmData(params model.GetAlarmDataRequest) models.Result[any] {
...
// 更新报警器历史消息
func UpdateAlarmData(params model.UpdateAlarmDataRequest) models.Result[any] {
...
// 统计报警消息数量
func GetZWatchAlertHistogram(params model.GetZWatchAlertHistogramRequest) models.Result[any] {
...
// 查询资源报警器报警记录
func QueryAlarmRecord(params model.QueryAlarmRecordRequest) models.Result[any] {
	//GET zstack/v1/zwatch/alarm-histories
	url := fmt.Sprintf("zstack/v1/zwatch/alarm-histories")
...
// 订阅事件
func SubscribeEvent(params model.SubscribeEventRequest) models.Result[any] {
...
// 退订事件
func UnsubscribeEvent(params model.UnsubscribeEventRequest) models.Result[any] {
...
// 查询事件订阅
func QueryEventSubscription(params model.QueryEventSubscriptionRequest) models.Result[any] {
...
// 更新事件订阅的标签
func UpdateEventSubscriptionLabel(params model.UpdateEventSubscriptionLabelRequest) models.Result[any] {
...
// 创建报警消息模板
func CreateSNSTextTemplate(params model.CreateSNSTextTemplateRequest) models.Result[any] {
...
// 删除报警消息模板
func DeleteSNSTextTemplate(params model.DeleteSNSTextTemplateRequest) models.Result[any] {
...
// 更新报警消息模板
func UpdateSNSTextTemplate(params model.UpdateSNSTextTemplateRequest) models.Result[any] {
...
// 查询报警消息模板
func QuerySNSTextTemplate(params model.QuerySNSTextTemplateRequest) models.Result[any] {
...
// 创建SNS监控阿里云短信模板
func CreateAliyunSmsSNSTextTemplate(params model.CreateAliyunSmsSNSTextTemplateRequest) models.Result[any] {
...
// 更新SNS阿里云短信文本模板
func UpdateAliyunSmsSNSTextTemplate(params model.UpdateAliyunSmsSNSTextTemplateRequest) models.Result[any] {
	//PUT zstack/v1/zwatch/alarms/sns/text-templates/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/zwatch/alarms/sns/text-templates/%s/actions", params.UUID)
...
// 查询SNS监控阿里云短信模板
func QueryAliyunSmsSNSTextTemplate(params model.QueryAliyunSmsSNSTextTemplateRequest) models.Result[any] {
...
// 获取审计数据
func GetAuditData(params model.GetAuditDataRequest) models.Result[any] {
