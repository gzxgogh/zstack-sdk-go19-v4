...
// 更改虚拟IP启用状态
func ChangeEipState(params model.ChangeEipStateRequest) models.Result[any] {
	//PUT zstack/v1/eips/{uuid}/actions
	url := fmt.Sprintf("zstack/v1/eips/%s/actions", params.UUID)
...
// 获取可绑定指定弹性IP的云主机网卡
func GetEipAttachableVmNics(params model.GetEipAttachableVmNicsRequest) models.Result[any] {
...
// 绑定弹性IP
func AttachEip(params model.AttachEipRequest) models.Result[any] {
...
// 解绑弹性IP
func DetachEip(params model.DetachEipRequest) models.Result[any] {
