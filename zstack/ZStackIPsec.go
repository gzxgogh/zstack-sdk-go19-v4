...
// 创建IPsec连接
func CreateIPsecConnection(params model.CreateIPsecConnectionRequest) models.Result[any] {
...
// 删除IPsec连接
func DeleteIPsecConnection(params model.DeleteIPsecConnectionRequest) models.Result[any] {
...
// 更新IPsec连接
func UpdateIPsecConnection(params model.UpdateIPsecConnectionRequest) models.Result[any] {
...
// 查询IPsec连接
func QueryIPSecConnection(params model.QueryIPSecConnectionRequest) models.Result[any] {
	//GET zstack/v1/ipsec
...
// 更改IPsec连接状态
func ChangeIPSecConnectionState(params model.ChangeIPSecConnectionStateRequest) models.Result[any] {
...
// 添加三层网络到IPsec连接
func AttachL3NetworksToIPsecConnection(params model.AttachL3NetworksToIPsecConnectionRequest) models.Result[any] {
...
// 从IPsec连接删除三层网络
func DetachL3NetworksFromIPsecConnection(params model.DetachL3NetworksFromIPsecConnectionRequest) models.Result[any] {
...
// 添加远端CIDR到IPsec连接
func AddRemoteCidrsToIPsecConnection(params model.AddRemoteCidrsToIPsecConnectionRequest) models.Result[any] {
...
// 删除远端CIDR
func RemoveRemoteCidrsFromIPsecConnection(params model.RemoveRemoteCidrsFromIPsecConnectionRequest) models.Result[any] {
